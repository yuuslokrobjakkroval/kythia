...
document.addEventListener("DOMContentLoaded", (_o) => {
	var _e = config.colors.cardColor,
		_r = config.colors.headingColor,
		t = config.colors.bodyColor,
		i = config.colors.textMuted,
		s = config.colors.borderColor,
		a = config.fontFamily,
		_n = document.querySelector("#orderChart"),
		_l = {
			chart: {
				height: 80,
				type: "area",
