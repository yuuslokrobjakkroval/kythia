								...
								if (
									...
									n
										...
										: ((this.settings.defaultPrimaryColor =
												O.getPropertyValue("--ky-primary").trim()),
											(z = !1)),
								...
								},
								{
									...
									value: function () {
										...
										var a = this.container.querySelector(
											...
											s = () => {
												this.clearLocalStorage(), window.location.reload();
											};
										...
										if (this._hasControls("color")) {
											...
											this.settings.availableColors.forEach((e) => {
												var o =
														'<div class="form-check custom-option custom-option-icon mb-0">\n          <label class="form-check-label custom-option-content p-0" for="'
															...
															.concat(d)
															.concat(e.name, '" />\n        </div>'),
													i = this._getElementFromString(o);
												u.appendChild(i);
											}),
												u.appendChild(
										...
										if (this._hasControls("theme")) {
											this.settings.availableThemes.forEach((t) => {
												var e = o(
													t.name,
													t.title,
													"customRadioIcon",
											...
											var v = (e) => {
												...
												window.Helpers.syncThemeToggles(e.target.value),
													this.setTheme(e.target.value, !0, () => {
														this._loadingState(!1);
													});
											};
										...
										if (this._hasControls("skins")) {
											this.settings.availableSkins.forEach((t) => {
											...
											var y = (e) => {
												document.documentElement.setAttribute(
													...
													this.setSkin(e.target.value, !0, () => {
														this._loadingState(!1, !0);
													});
											};
										...
										if (
											...
											if (this._hasControls("layoutCollapsed")) {
												...
												this.settings.availableMenuCollapsed.forEach((t) => {
											...
											if (this._hasControls("contentLayout")) {
												...
												this.settings.availableContentLayouts.forEach((t) => {
													var e = o(
														t.name,
														t.title,
														"contentRadioIcon",
												...
												var N = (e) => {
													(this._loading = !0),
														...
														this.setContentLayout(e.target.value, !0, () => {
											...
											if (this._hasControls("headerType")) {
												...
												setTimeout(() => {
													...
													this.settings.availableHeaderTypes.forEach((t) => {
														var e = o(
															t.name,
															t.title,
															"headerRadioIcon",
											...
											if (this._hasControls("layoutNavbarOptions")) {
												...
												this.settings.availableNavbarOptions.forEach((t) => {
													var e = o(
														t.name,
														t.title,
														"navbarOptionRadios",
											...
											if (this._hasControls("rtl")) {
												...
												this.settings.availableDirections.forEach((t) => {
													var e = o(
														t.name,
														t.title,
														"directionRadioIcon",
												...
												var P = (e) => {
													this._setSetting("Lang", this.settings.lang),
														this._setSetting(
															"Lang",
															"ar" === this.settings.lang ? "en" : "ar",
														),
														(this.settings.rtl = "rtl" === e.target.value);
													var o = this._getSetting("Lang"),
													...
													i
														...
														.click(),
														this._initDirection(),
														this.setRtl("rtl" === e.target.value, !0, () => {
															this._loadingState(!1);
														});
												};
								...
								},
								{
									...
									value: function (t) {
										...
										return t
											...
											.reduce(
												(t, i) => (
													-1 !== this.settings.controls.indexOf(i)
														? (o || !1 !== t) && (t = !0)
														: (o && !0 === t) || (t = !1),
													t
												),
