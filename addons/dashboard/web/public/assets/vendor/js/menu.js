			...
			a = (() => {
				...
				return (
							...
							value: function () {
								(this._evntElClick = (n) => {
									if (
										...
										i && (this._topParent = i.childNodes[0]);
									}
									...
									o &&
										(n.preventDefault(),
										"true" !== o.getAttribute("data-hover") && this.toggle(o));
								}),
									...
									(this._evntWindowResize = () => {
										...
										this._horizontal || e || this.manageScroll();
									}),
									window.addEventListener("resize", this._evntWindowResize),
									this._horizontal &&
										((this._evntPrevBtnClick = (e) => {
											e.preventDefault(),
												this._prevBtn.classList.contains("disabled") ||
													this._slide("prev");
										}),
										...
										(this._evntNextBtnClick = (e) => {
											e.preventDefault(),
												this._nextBtn.classList.contains("disabled") ||
													this._slide("next");
										}),
										...
										this._showDropdownOnHover &&
											...
											(this._evntElMouseOut = (n) => {
												...
												if (
													...
													if (
														this._topParent &&
														!e.childOf(r, this._topParent.parentNode)
													) {
														var s = this._topParent.classList.contains(
															"menu-toggle",
														)
															? this._topParent
															: null;
														s &&
															...
															"true" !== s.getAttribute("data-hover") &&
																(this.toggle(s), (this._topParent = null)));
													}
							...
							value: function (t) {
								...
								if (o) {
									...
									e._promisify(this._onOpen, this, o, r, e._findMenu(o))
										.then(() => {
											this._horizontal && e._isRoot(o)
												? (this._toggleDropdown(!0, o, i),
													this._onOpened?.(this, o, r, e._findMenu(o)))
												: this._animate && !this._horizontal
													? (window.requestAnimationFrame(() =>
															this._toggleAnimation(!0, o, !1),
														),
														this._accordion && this._closeOther(o, i))
													: this._animate
														? (this._toggleDropdown(!0, o, i),
															this._onOpened?.(this, o, r, e._findMenu(o)))
							...
							value: function (t) {
								...
								r.classList.contains("open") &&
									...
									e
										...
										.then(() => {
											if (this._horizontal && e._isRoot(r))
												this._toggleDropdown(!1, r, i),
													this._onClosed?.(this, r, s, e._findMenu(r));
											else if (this._animate && !this._horizontal)
												window.requestAnimationFrame(() =>
													this._toggleAnimation(!1, r, i),
												);
											else {
							...
							value: function (t, n, i) {
								...
								t
									? ((n.style.height = "".concat(l, "px")),
										...
										e._bindAnimationEndEvent(n, () => {
											a(), this._onOpened(this, n, r, s);
										}),
										setTimeout(() => {
					...
					(o = [
						...
						{
							key: "_isRoot",
							value: (t) => !e._findParent(t, "menu-item", !1),
						},
						{
							key: "_findParent",
							value: function (e, t) {
						...
						},
						{
							...
							value: (e) => {
								for (var t = e.childNodes[0], n = null; t && !n; )
									t.classList?.contains("menu-sub") && (n = t),
										(t = t.nextSibling);
								if (!n)
									throw new Error(
						...
						},
						{
							...
							value: (t, n) => {
								...
								(o = parseFloat(o) * (-1 !== o.indexOf("ms") ? 1 : 1e3)),
									...
									l.forEach((e) =>
										t.addEventListener(e, t._menuAnimationEndEventCb, !1),
									),
						...
						},
						{
							...
							value: (e) => {
								...
								e._menuAnimationEndEventTimeout &&
									...
									t &&
										(l.forEach((n) => e.removeEventListener(n, t, !1)),
						...
						{
							key: "isActive",
							value: (t) => e._getItem(t, !1).classList.contains("active"),
						},
						{
							key: "isOpened",
							value: (t) => e._getItem(t, !1).classList.contains("open"),
						},
						{
							key: "isDisabled",
							value: (t) => e._getItem(t, !1).classList.contains("disabled"),
						},
					]),
					n && r(t.prototype, n),
					o && r(t, o),
