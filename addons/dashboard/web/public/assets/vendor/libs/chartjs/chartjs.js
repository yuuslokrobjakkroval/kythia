	...
	(() => {
		...
		function M(t) {
			...
			return (
				(i =
					"hwb" === e[1]
						? ((t, e, i) => _(b, t, e, i))(a, r, h)
						: "hsv" === e[1]
							? ((t, e, i) => _(m, t, e, i))(a, r, h)
							: y(a, r, h)),
		...
		const O = (t) =>
			...
			C = (t) => (t <= 0.04045 ? t / 12.92 : ((t + 0.055) / 1.055) ** 2.4);
		function A(t, e, i) {
			if (t) {
				let s = x(t);
		...
		function J(t, e, i) {
			...
			const s = e[t],
				n = i[t];
			B(s) && B(n) ? Z(s, n) : Object.hasOwn(e, t) || (e[t] = X(n));
		}
		...
		const It =
			"undefined" == typeof window ? (t) => t() : window.requestAnimationFrame;
		function zt(t, e) {
			let i = [],
				s = !1;
			return (...n) => {
		...
		const Nt = (t) => 0 === t || 1 === t,
			Ht = (t, e, i) => -(2 ** (10 * (t -= 1))) * Math.sin(((t - e) * at) / i),
			jt = (t, e, i) => 2 ** (-10 * t) * Math.sin(((t - e) * at) / i) + 1,
			$t = {
				linear: (t) => t,
				easeInQuad: (t) => t * t,
				easeOutQuad: (t) => -t * (t - 2),
		...
		const Jt = {
			...
			logarithmic(t, e, i) {
				if (0 === t) return "0";
				const s = i[e].significand || t / 10 ** Math.floor(ft(t));
		...
		function ze(t, e, i) {
			if (Object.hasOwn(t, e) || "constructor" === e) return t[e];
			const s = i();
			return (t[e] = s), s;
		}
		function Fe(t, e, i) {
		...
		function li(t, e) {
			const i = ((t, e) => ei(t).getPropertyValue(e))(t, e),
				s = i && i.match(/^(\d+)(\.\d+)?px$/);
			return s ? +s[1] : void 0;
		}
		function ci(t, e, i, s) {
		...
		function Mi(t, e) {
			if (!e) return !1;
			const i = [],
				s = (t, e) => (Yt(e) ? (i.includes(e) || i.push(e), i.indexOf(e)) : e);
		...
		function Ii(t, e) {
			const { chart: i, _cachedMeta: s } = t,
				...
				h = o.axis,
				l = a.axis,
				c = ((t, e, i) => `${t.id}.${e.id}.${i.stack || i.type}`)(o, a, s),
				d = e.length;
			let u;
			for (let t = 0; t < d; ++t) {
				const i = e[t],
		...
		class Ks {
			...
			register(t) {
				...
				let i;
				((t) => "id" in t && "defaults" in t)(e) && (i = this.register(e));
				const s = this.items,
					n = t.id,
					o = this.scope + "." + n;
		...
		class fn {
			constructor(t) {
				(this._config = ((t) => (((t = t || {}).data = hn(t.data)), rn(t), t))(
					t,
				)),
		...
		function xn(t, e) {
			return (i, s) => (i[t] === s[t] ? i[e] - s[e] : i[t] - s[t]);
		}
		function _n(t) {
			const e = t.chart,
			...
			_handleEvent(t, e, i) {
				const { _active: s = [], options: n } = this,
					...
					r = ((t) =>
						"mouseup" === t.type ||
						"click" === t.type ||
						"contextmenu" === t.type)(t),
					h = ((t, e, i, s) =>
						i && "mouseout" !== t.type ? (s ? e : t) : null)(
						t,
						this._lastEvent,
						i,
						r,
		...
		var qn = Object.freeze({
			...
			PointElement: class extends Vs {
				...
				inRange(t, e, i) {
					...
					return (t - n) ** 2 + (e - o) ** 2 < (s.hitRadius + s.radius) ** 2;
				}
				inXRange(t, e) {
			...
			return (i, s) => {
				...
				n instanceof Ki
					...
					: n instanceof Gi
						...
						: n &&
							(e = ((t, e) => (
								(t.borderColor = Zn(e)), (t.backgroundColor = Jn(e)), ++e
							))(i, e));
			};
		}
		function to(t) {
			...
			_fitCols(t, e, i, s) {
				...
				return (
					this.legendItems.forEach((t, o) => {
						const { itemWidth: p, itemHeight: m } = ((t, e, i, s, n) => {
							const o = ((t, e, i, s) => {
									let n = t.text;
									n &&
										"string" != typeof n &&
		...
		function sa(t, { min: e, max: i }) {
			...
			let o = ((t, e) => {
				...
				a = o < 0 ? 10 ** Math.abs(o) : 1;
			const r = 10 ** o,
				h = n > o ? 10 ** n : 0,
				l = Math.round((e - h) * a) / a,
				c = Math.floor((e - h) / r / 10) * r * 10;
			let d = Math.floor((l - c) / 10 ** o),
				u = N(t.min, Math.round((h + c + d * 10 ** o) * a) / a);
			for (; u < i; )
				s.push({ value: u, major: ea(u), significand: d }),
					d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
					d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
					(u = Math.round((h + c + d * 10 ** o) * a) / a);
			const f = N(t.max, u);
		...
		class na extends qs {
			...
			getValueForPixel(t) {
				...
				return 10 ** (this._startValue + e * this._valueRange);
			}
		}
		function oa(t) {
			const e = t.ticks;
		...
		class fa extends Zo {
			...
			getPointLabelContext(t) {
				...
				if (t >= 0 && t < e.length) {
					const i = e[t];
					return ((t, e, i) =>
						Ae(t, { label: i, index: e, type: "pointLabel" }))(
						this.getContext(),
						t,
						i,
					);
