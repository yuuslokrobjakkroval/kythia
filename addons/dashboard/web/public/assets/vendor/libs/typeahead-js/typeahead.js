							...
							(s.Bloodhound =
								...
								(n = (() => {
									return {
										...
										isJQuery: (t) => t instanceof e,
										toStr: (t) =>
											n.isUndefined(t) || null === t ? "" : `${t}`,
										bind: e.proxy,
										each: (t, n) => {
											function i(t, e) {
												return n(e, t);
										...
										mixin: e.extend,
										identity: (t) => t,
										clone: (t) => e.extend(!0, {}, t),
										getIdGenerator: () => {
											var t = 0;
											return () => t++;
										},
										templatify: (t) => (e.isFunction(t) ? t : n),
										defer: (t) => {
											setTimeout(t, 0);
										},
										debounce: (t, e, n) => {
										...
										stringify: (t) => (n.isString(t) ? t : JSON.stringify(t)),
										noop: () => {},
									};
								})()),
								(i = "0.11.1"),
											...
											n.mixin(r.prototype, {
												...
												add: function (e) {
													(e = n.isArray(e) ? e : [e]),
														n.each(e, (e) => {
															var u, a;
															(this.datums[(u = this.identify(e))] = e),
																(a = s(this.datumTokenizer(e))),
																n.each(a, (e) => {
																	var n, s, a;
																	for (
																		n = this.trie, s = e.split("");
																		(a = s.shift());
																	)
												...
												get: function (t) {
													return n.map(t, (t) => this.datums[t]);
												},
												search: function (e) {
													var r, o;
													return (
										...
										n.mixin(e.prototype, {
											...
											fromNetwork: function (t) {
												...
												t &&
													...
													this.transport(e).fail(i).done(r));
											},
											clear: function () {
								...
								(f = (() => {
									...
									function _s(t) {
										...
										function s(t, e) {
											return (
												(e.url = e.url.replace(i, encodeURIComponent(t))), e
											);
										}
										function o(_t, e) {
											return e;
									...
									function o(t) {
										...
										function s(t) {
											return (e) => n.debounce(e, t);
										}
										function o(t) {
											return (e) => n.throttle(e, t);
										}
									}
									function u(t) {
										return (i) => {
									...
									return (
										...
										n.mixin(i.prototype, {
											...
											clearPrefetchCache: function () {
												return this.prefetch?.clear(), this;
											},
						...
						(r = ((t) => (
							...
							(n = (() => {
								return {
									...
									isElement: (t) => !(!t || 1 !== t.nodeType),
									isJQuery: (t) => t instanceof e,
									toStr: (t) => (n.isUndefined(t) || null === t ? "" : `${t}`),
									bind: e.proxy,
									each: (t, n) => {
										function i(t, e) {
											return n(e, t);
							...
							(r = (() => {
								var t, i;
								function r(t) {
									t?.el || e.error("EventBus initialized without el"),
										(this.$el = e(t.el));
								}
								return (
									(t = "typeahead:"),
							...
							(s = (() => {
								...
								function o(n) {
									...
									for (
										...
										(i = n.shift()) && (r = this._callbacks[i]);
									)
										(o = u(r.sync, this, [i].concat(s))),
											(a = u(r.async, this, [i].concat(s))),
											o() && e(a);
									return this;
								}
								function u(t, e, n) {
								...
								return (r) => {
									...
									function u(t, e) {
										for (var n, i = 3, r = 0; r < t.childNodes.length; r++)
											(n = t.childNodes[r]).nodeType === i
												? (r += e(n) ? 1 : 0)
												: u(n, e);
									}
									(r = n.mixin({}, e, r)).node &&
										r.pattern &&
										((r.pattern = n.isArray(r.pattern)
											? r.pattern
											: [r.pattern]),
											...
											return (
												...
												!n.isMsie() || n.isMsie() > 9
													...
													: this.$input.on(
															...
															(e) => {
																t[e.which || e.keyCode] ||
																	n.defer(n.bind(this._onInput, this, e));
															},
														),
												this
											);
									...
									n.mixin(r.prototype, s, {
										...
										_getSuggestionsFragment: function (i, r) {
											...
											return (
												...
												n.each(r, (n) => {
													var r, o;
													(o = this._injectQuery(i, n)),
														(r = e(this.templates.suggestion(o))
															.data(t.obj, n)
															.data(t.val, this.displayFn(n))
															.addClass(
										...
										_injectQuery: (t, e) =>
											n.isObject(e) ? n.mixin({ _query: t }, e) : e,
										update: function (t) {
											var n = this,
												i = !1,
												r = !1,
								...
								return (
									n.mixin(t.prototype, s, {
										...
										_removeCursor: function () {
											...
											t?.removeClass(this.classes.cursor);
										},
										...
										bind: function () {
											...
											return (
												...
												n.each(this.datasets, (t) => {
													t.onSync("asyncRequested", this._propagate, this)
														.onSync("asyncCanceled", this._propagate, this)
														.onSync("asyncReceived", this._propagate, this)
														.onSync("rendered", this._onRendered, this)
														.onSync("cleared", this._onCleared, this);
												}),
												this
											);
										},
										...
										update: function (t) {
											var e = t !== this.query;
											return (
												e && ((this.query = t), n.each(this.datasets, i)), e
											);
											function i(e) {
												e.update(t);
											}
							...
							(l = (() => {
								...
								return (
									n.mixin(t.prototype, {
										...
										_onSelectableClicked: function (_t, e) {
											this.select(e);
										},
										_onDatasetCleared: function () {
											this._updateHint();
										},
										_onDatasetRendered: function (_t, e, n, i) {
											this._updateHint(),
												this.eventBus.trigger("render", n, i, e);
										},
										_onAsyncRequested: function (_t, e, n) {
											this.eventBus.trigger("asyncrequest", n, e);
										},
										_onAsyncCanceled: function (_t, e, n) {
											this.eventBus.trigger("asynccancel", n, e);
										},
										_onAsyncReceived: function (_t, e, n) {
										...
										_onEnterKeyed: function (_t, e) {
											var n;
											(n = this.menu.getActiveSelectable()) &&
												this.select(n) &&
												e.preventDefault();
										},
										_onTabKeyed: function (_t, e) {
											var n;
											(n = this.menu.getActiveSelectable())
										...
										_onLangDirChanged: function (_t, e) {
											this.dir !== e &&
