...
!((t, e) => {
	...
	(() => {
		...
		var a = {
			...
			r = (t, e) => t && Array.isArray(t) && t.map((t) => l(t, e));
		function l(t, e) {
			var i,
				n = {};
		...
		function y(t) {
			return (
				w.call(this, t) &&
				(null == t ? void 0 : t.closest(this.settings.classNames.tagSelector))
			);
		}
		function w(t) {
			return (
		...
		function O(t, e, i) {
			return t
				? (e && (t.__tagifyTagData = i ? e : h({}, t.__tagifyTagData || {}, e)),
					t.__tagifyTagData)
					...
					{},
					{
								...
								onKeyDown: function (t) {
									if (this.state.hasFocus && !this.state.composing) {
										var i = this.settings,
											...
											o = "mix" === i.mode,
											r = "select" === i.mode;
										i.hooks.beforeKeyDown(t, { tagify: this }).then((_l) => {
											switch (t.key) {
												case "ArrowDown":
												case "ArrowUp":
												case "Down":
												case "Up": {
													t.preventDefault();
													var d = this.dropdown.getAllSuggestionsRefs(),
														c = "ArrowUp" === t.key || "Up" === t.key;
													n && (n = this.dropdown.getNextOrPrevOption(n, !c)),
														n?.matches(i.classNames.dropdownItemSelector) ||
															(n = d[c ? d.length - 1 : 0]),
												...
												case "PageDown": {
													var u;
													t.preventDefault();
													var g = this.dropdown.getAllSuggestionsRefs(),
														h =
															Math.floor(
																this.DOM.dropdown.content.clientHeight /
																	(null === (u = g[0]) || void 0 === u
																		? void 0
																		: u.offsetHeight),
															) || 1,
												...
												case "End": {
													t.preventDefault();
													var v = this.dropdown.getAllSuggestionsRefs();
													(n = v["Home" === t.key ? 0 : v.length - 1]),
														this.dropdown.highlightOption(n, !0);
													break;
												}
												case "Escape":
												...
												case "Tab": {
													...
													if (!o && !r && n && b && !this.state.editing && s) {
														t.preventDefault();
														var y = this.dropdown.getMappedValue(s);
														return (
															(this.state.autoCompleteData = s),
															this.input.autocomplete.set.call(this, y),
															!1
														);
													}
													return !0;
												...
												case "Enter":
													t.preventDefault(),
														...
														i.hooks
															...
															.then(() => {
																if (n)
																	return (
																		this.dropdown.selectOption(n),
																		(n = this.dropdown.getNextOrPrevOption(
																			n,
																			!c,
																		)),
																		void this.dropdown.highlightOption(n)
																	);
																this.dropdown.hide(),
																	o ||
																		this.addTags(
													...
													break;
												case "Backspace": {
													if (o || this.state.editing.scope) return;
													var w = this.input.raw.call(this);
									...
									if (
										...
										(this.state.actions.selectOption = !0),
											...
											this.settings.hooks
												...
												.then(() => {
													i
														? this.dropdown.selectOption(i, t)
														: this.dropdown.hide();
												})
												.catch((t) => a.warn(t));
									}
						...
						getSuggestionDataByNode: function (t) {
							for (
								...
								if (g((e = this.suggestedListItems[n])) && e.value === i)
									return e;
						...
						selectOption: function (t, e) {
							...
							var r = t.getAttribute("value"),
								l = "noMatch" === r,
								d = "mix" === n.mode,
								c = this.suggestedListItems.find((t) => {
									var e;
							...
							if (
								...
								if (this.state.editing) {
									...
									(c = n.transformTag.call(this, u) || u),
										this.onEditTagDone(null, h({ __isValid: !0 }, c));
								} else
									...
									t.addEventListener(
										...
										() => {
											this.dropdown.fillHeaderFooter(),
												setTimeout(() => {
													t.remove(), this.dropdown.refilter();
												}, 100);
										},
										{ once: !0 },
									),
						...
						filterListItems: function (t, e) {
								...
								l = () => {
									...
									(t = m[T]),
										(n = (
											...
											: { value: m[T] });
									var v,
										b = Object.keys(n).some((t) => w.includes(t))
											? w
											: ["value"];
									u.fuzzySearch && !e.exact
										? ((a = b
											...
											(s = r
												.toLowerCase()
												.split(" ")
												.every((t) => v.includes(t.toLowerCase()))))
										: ((d = !0),
											(s = b.some((t) => {
												var i = `${n[t] || ""}`;
												return (
										...
										(o =
											...
											i.isTagDuplicate(g(n) ? n.value : n)),
										s &&
											!o &&
											(c && d
												? p.push(n)
							...
							if (
								...
								h = b
									? m
									: m.filter((t) => !this.isTagDuplicate(g(t) ? t.value : t));
								var O = y ? u.sortby(h, r) : h.slice(0, v);
								return (this.state.dropdown.suggestions = O), O;
							}
							for (
								r = u.caseSensitive ? `${t}` : `${t}`.toLowerCase();
								T < m.length;
								T++
							)
								(i = this), l();
							...
							return h([], t)
								.map((t, _i) => {
									("string" !== typeof t && "number" !== typeof t) ||
										(t = { value: t });
									var n = this.dropdown.getMappedValue(t);
									return (
										(n =
											"string" === typeof n && this.settings.dropdown.escapeHTML
												? u(n)
												: n),
								...
								if (
									...
									t &&
										...
										a.templates.dropdownItemNoMatch &&
											(n = a.templates.dropdownItemNoMatch.call(this, {
												value: t,
											}))),
									!n)
								) {
		...
		var K = {
			...
			callbacks: {
				onFocusBlur: function (t) {
					...
					o && "mix" !== n.mode && this.DOM.input.focus(),
						s &&
							...
							!a &&
							!o &&
							this.toggleFocusClass((this.state.hasFocus = Date.now()));
					...
					if (!(h || p || o))
						if (
							((this.state.hasFocus = !(!r && !s) && Date.now()),
							...
							if (r) {
								...
								var f =
										0 === n.dropdown.enabled && !this.state.dropdown.visible,
									m = !a || "select" === n.mode;
								return (
				...
				onCompositionStart: function (_t) {
					this.state.composing = !0;
				},
				onCompositionEnd: function (_t) {
									...
									switch (t.key) {
										...
										case "ArrowRight": {
											...
											if (v && i.autoComplete.rightKey)
												return void this.addTags([v], !0);
											break;
										}
										case "Tab":
											return !0;
										case "Enter": {
											if (this.state.dropdown.visible && !f) return;
											t.preventDefault();
											var b = this.state.autoCompleteData || n;
											setTimeout(() => {
												(this.state.dropdown.visible && !f) ||
													this.state.actions.selectOption ||
				...
				onMixTagsInput: function (t) {
					...
					if (
						...
						this.value.slice().forEach((t) => {
							t.readonly &&
								!v.includes(t.value) &&
								p.appendChild(this.createTagElem(t));
						}),
						p.childNodes.length &&
							(f.insertNode(p), this.setRangeAtStartEnd(!1, p.lastChild)),
						g.length !== u)
					)
						return (
							(this.value = [].map.call(this.getTagElms(), (t) => O(t))),
					...
					if (
						...
						if (
							...
							(n =
								(e = f.toString().slice(0, f.endOffset)).split(c.pattern)
									.length - 1),
							(i = e.match(c.pattern)) &&
					...
					setTimeout(() => {
						this.update({ withoutChangeEvent: !0 }),
							...
							this.state.tag &&
								this.dropdown[a ? "show" : "hide"](this.state.tag.value);
					}, 10);
				},
				onInputIE: function (t) {
					setTimeout(() => {
						this.events.callbacks.onInput.call(this, t);
					});
				},
				...
				onClickScope: function (t) {
					var e = this.settings,
						...
						s = Date.now() - this.state.hasFocus;
									...
									a &&
										...
										"mix" === this.settings.mode
											...
											: this.settings.pasteAsTags
												? (i = this.addTags(this.state.inputText + a, !0))
				...
				onEditTagBlur: function (t, e) {
					...
					if (
						...
						var n,
							...
							c =
								(B((n = {}), o.tagTextProp, d), B(n, "__tagId", l.__tagId), n),
							u = l.__originalData,
						...
						if (d)
							if (g) {
								...
								if (
									...
									!0 !==
										(p = (!s || !0 === u.__isValid) && this.validateTag(a)))
								) {
									if (
										(this.trigger("invalid", { data: a, tag: r, message: p }),
				...
				onEditTagkeydown: function (t, e) {
					if (!this.state.composing)
						switch ((this.trigger("edit:keydown", { event: t }), t.key)) {
							...
							case "Enter":
							case "Tab":
								t.preventDefault(), setTimeout(() => t.target.blur(), 0);
						}
				},
						...
						t.addedNodes.forEach((t) => {
							if ("<div><br></div>" === t.outerHTML)
								...
								3 === t.childNodes[0].nodeType &&
									...
									(i = t).replaceWith.apply(
										i,
										U([n].concat(U(U(t.childNodes).slice(0, -1)))),
									),
									x(n);
							} else if (b.call(this, t)) {
								var s;
								if (
									(3 !==
									...
									(t.previousSibling && !O(t.previousSibling)) || t.before("​");
							}
						}),
							t.removedNodes.forEach((t) => {
								t &&
									"BR" === t.nodeName &&
									b.call(this, i) &&
									(this.removeTags(i), this.fixFirefoxLastTagNoCaret());
							});
					});
				...
				((t) => {
					...
					function n(t, i, n) {
						n &&
							i
								.split(/\s+/g)
								.forEach((i) => e[`${t}EventListener`].call(e, i, n));
					}
					return {
							...
							if (((s = s || { cloneData: !0 }), i))
								if (t.settings.isJQueryPlugin)
									"remove" === i && (i = "removeTag"),
										jQuery(t.DOM.originalInput).triggerHandler(i, [n]);
								else {
									try {
		...
		($.prototype = {
			...
			applySettings: function (t, e) {
				...
				var s = h(
						{},
						S,
						"mix" === e.mode ? { dropdown: { position: "text" } } : {},
					),
				...
				Array.isArray(o) &&
					(this.whitelist = Array.isArray(a.whitelist) ? p(a.whitelist, o) : o);
			},
			...
			setPlaceholder: function (t) {
				["data", "aria"].forEach((i) =>
					this.DOM.input.setAttribute("".concat(i, "-placeholder"), t),
				);
			},
			...
			setRangeAtStartEnd: function (t, e) {
				if (e) {
					...
					if (X(i.focusNode, Element) && !this.DOM.input.contains(i.focusNode))
						return !0;
					try {
						i.rangeCount >= 1 &&
							["Start", "End"].forEach((n) =>
								i.getRangeAt(0)[`set${n}`](e, t || e.length),
							);
					} catch (_t) {}
				}
			},
			insertAfterTag: function (t, e) {
				if (
					((e = e || this.settings.mixMode.insertAfterTag), t?.parentNode && e)
				)
					return (
			...
			updateValueByDOMTags: function () {
				...
				[].forEach.call(this.getTagElms(), (e) => {
					G(e.classList).some((t) => i.includes(t)) || this.value.push(O(e));
				}),
					this.update();
			},
			...
			input: {
				...
				normalize: function (t, e) {
					var i = t || this.DOM.input,
						n = [];
					i.childNodes.forEach((t) => 3 === t.nodeType && n.push(t.nodeValue)),
						(n = n.join("\n"));
					try {
						n = n.replace(
							/(?:\r\n|\r|\n)/g,
			...
			getTagElms: function () {
				...
				var n =
					"." +
					G(this.settings.classNames.tag.split(" ")).concat(G(e)).join(".");
			...
			getTagIndexByValue: function (t) {
				...
				return (
					this.getTagElms().forEach((s, a) => {
						s.__tagifyTagData &&
							o(this.trim(s.__tagifyTagData.value), t, n) &&
							i.push(a);
					}),
					i
				);
				...
				return (
					(i = i || s.whitelist).some((i) => {
						...
						if (o(a, t, s.dropdown.caseSensitive, s.trim))
							return (n = "object" === typeof i ? i : { value: i }), !0;
					}),
					n ||
						"value" !== e ||
						"value" === s.tagTextProp ||
			...
			normalizeTags: function (t) {
				...
				return (
					l &&
						!c &&
						(t.forEach((t) => {
							var i = r.map((t) => t.value),
								n = this.dropdown.filterListItems.call(this, t[o], {
									exact: !0,
								});
							this.settings.duplicates ||
								(n = n.filter((t) => !i.includes(t.value)));
							var s = n.length > 1 ? this.getWhitelistItem(t[o], o, n) : n[0];
							s && X(s, Object)
								? r.push(s)
								: "mix" !== a &&
				...
				(t = t
					...
					.map((t, i) => {
						...
						try {
							...
							u = this.normalizeTags(p)[0] || { value: p };
						}
						if (
							(a.call(this, u),
							f ||
								!(h.length > 1) ||
								(o && !this.isTagWhitelisted(u.value)) ||
								(!s && this.isTagDuplicate(u.value)))
						) {
							if (t) return i ? n[0] + t : t;
						} else
							(u[(c = u[l] ? l : "value")] = this.trim(u[c])),
								(g = this.createTagElem(u)),
								d.push(u),
				...
				if (this.state.tag || e) {
					...
					return (
						...
						-1 === (i = a.nodeValue.lastIndexOf(e)) ||
							((n = a.splitText(i)), t && a.parentNode.replaceChild(t, n)),
						!0
					);
				}
			},
			...
			postProcessNewTagNode: function (t, e) {
				...
				s && !0 === s
					...
					: (this.trigger("invalid", {
						...
						n.keepInvalidTags || setTimeout(() => this.removeTags(t, !0), 1e3)),
					this.dropdown.position();
			},
			...
			addTags: function (t, e, i) {
				...
				return (
					...
					t.forEach((t) => {
						var e = this.prepareNewTagNode(t, {
						...
						if (e) {
							...
							if (
								...
								return this.selectTag(d, t);
							r.appendChild(d),
								this.postProcessNewTagNode(d, t),
			...
			addMixTags: function (t) {
				...
				return (
					t.forEach((t) => {
						var n = this.prepareNewTagNode(t);
						i.appendChild(n.tagElm),
							this.insertAfterTag(n.tagElm),
							this.postProcessNewTagNode(n.tagElm, n.tagData);
					}),
			...
			prefixedTextToTag: function (t) {
				...
				if (
					...
					setTimeout(
						() => i.classList.add(this.settings.classNames.tagNoAnimation),
						300,
					),
					this.update(),
					!o)
			...
			reCheckInvalidTags: function () {
				var e = this.settings;
				this.getTagElms(e.classNames.tagNotAllowed).forEach((i, _n) => {
					var s = O(i),
						a = this.hasMaxTags(),
						o = this.validateTag(s),
						r = !0 === o && !a;
					if (("select" === e.mode && this.toggleScopeValidation(o), r))
						return (
					...
					return a.hooks
						...
						.then(() => {
							...
							i && i > 10 && 1 === n.length
								...
								: n.forEach(t.bind(this)),
								e ||
									(this.removeTagsFromValue(n.map((t) => t.node)),
									this.update(),
									"select" === a.mode &&
										a.userInput &&
			...
			removeTagsFromDOM: function () {
				this.getTagElms().forEach((t) => t.remove());
			},
