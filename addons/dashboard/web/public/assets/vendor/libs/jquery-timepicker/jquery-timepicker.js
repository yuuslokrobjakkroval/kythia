									...
									return (
										...
										(i = [
											...
											},
											{
												...
												value: function (e) {
													...
													return (
														...
														!!this.list &&
															(this.list.find("li").each((_i, n) => {
																var r = parseInt(n.dataset.time, 10);
																if (!Number.isNaN(r))
											...
											},
											{
												...
												value: function (e, t) {
													if ("INPUT" === this.targetEl.nodeName) {
														...
														this.settings.useSelect &&
															"select" !== t &&
															this.list &&
															this.list.val(
																this._roundAndFormatTime(this.anytime2int(e)),
															);
													}
													...
													if (this.selectedValue !== e) {
														...
														var r = new CustomEvent("changeTime", p),
															s = new CustomEvent(
																"change",
																Object.assign(p, { detail: "timepicker" }),
															);
														return (
															"select" === t
											...
											},
											{
												...
												value: function () {
													this.settings;
													var t = this.list.find(".ui-timepicker-selected");
													...
													return (
														null !== i &&
															("string" !== typeof i && (i = this._int2time(i)),
															this._setTimeValue(i, "select")),
														!0
													);
												},
											},
											...
											},
											{
												...
												value: (e) => {
													...
													var t = 1;
													return (
														1 === e.length && (t = 10), parseInt(e, 10) * t || 0
													);
												},
											},
											{
											...
											},
											{
												...
												value: function (e) {
													...
													return (
														...
														!0 === e.closeOnScroll &&
															(e.closeOnScroll = window.document),
														e
													);
												},
											},
											{
												...
												value: function (e) {
													...
													for (
														t = (e = e.sort((e, t) => e[0] - t[0])).length - 1;
														t > 0;
														t--
													)
														e[t][0] <= e[t - 1][1] &&
											...
											},
											{
												...
												value: function (e) {
													...
													var t = parseInt(e % 60, 10),
														i = parseInt((e / 60) % 60, 10),
														n = parseInt((e / 3600) % 24, 10),
												...
												value: function () {
													...
													if (null !== t) {
														...
														if (i) {
															...
															var o = parseInt(i.dataset.time, 10);
											...
											{
												key: "_isFocused",
												value: (e) => e === document.activeElement,
											},
											{
									...
									var t = {
										...
										show: function (t) {
											var r = e(this),
												s = r[0].timepickerObj,
												a = s.settings;
											if ((t?.preventDefault(), a.useSelect))
												...
												if (
													...
													return (
														...
														a.closeOnScroll &&
															e(a.closeOnScroll).on("scroll.ui-timepicker", n),
										...
										hide: function (_e) {
											...
											return t?.hideMe(), b.hideAll(), this;
										},
										option: function (t, n) {
										...
										isVisible: function () {
											var e = this[0].timepickerObj;
											return !!(e?.list && b.isVisible(e.list));
										},
										setTime: function (e) {
											var t = this[0].timepickerObj,
												i = t.settings,
									...
									function _i(i) {
										...
										if (
											...
											"string" === typeof o
												...
												o.append(a),
												n._setSelected(),
												r.on("mousedown click", "li", function (_s) {
													i.off("focus.timepicker"),
														i.on("focus.timepicker-ie-hack", () => {
