...
!((e, t) => {
	...
	(() => {
					...
					for (let t = 0, a = s.length; t < a; t += 1) {
						...
						void 0 !== r &&
							...
							(u(e[a]) && u(i[a])
								...
								: !u(e[a]) && u(i[a])
									? ((e[a] = {}),
										i[a].__swiper__ ? (e[a] = i[a]) : m(e[a], i[a]))
									: (e[a] = i[a]));
					}
				}
			}
		...
		var O = {
			...
			off(e, t) {
				return !this.eventsListeners || this.destroyed
					? this
			...
			emit() {
				...
				"string" === typeof r[0] || Array.isArray(r[0])
					? ((t = r[0]), (s = r.slice(1, r.length)), (a = this))
					: ((t = r[0].events), (s = r[0].data), (a = r[0].context || this)),
					s.unshift(a);
				return (
					(Array.isArray(t) ? t : t.split(" ")).forEach((t) => {
						this.eventsAnyListeners?.length &&
							this.eventsAnyListeners.forEach((e) => {
								e.apply(a, [t, ...s]);
							}),
							this.eventsListeners?.[t]?.forEach((e) => {
								e.apply(a, s);
							});
					}),
					this
			...
			N = (e) => {
				...
				if (e.params.grid && e.params.grid.rows > 1) {
					const s = i,
						r = [s - t];
					return (
						r.push(...Array.from({ length: t }).map((_e, t) => s + a + t)),
		...
		var X = {
			...
			updateSlides: function () {
				...
				let L;
				P ? e.grid.initSlides(c) : e.grid?.unsetSlides();
				const I =
				...
				if ((0 === u.length && (u = [0]), 0 !== x)) {
					...
					c.filter(
						(_e, t) => !(s.cssMode && !s.loop) || t !== c.length - 1,
					).forEach((e) => {
						e.style[t] = `${x}px`;
					});
				}
			...
			updateAutoHeight: function (e) {
				...
				const n = (e) =>
					a ? this.slides[this.getSlideIndexByData(e)] : this.slides[e];
				if (
					"auto" !== this.params.slidesPerView &&
					this.params.slidesPerView > 1
				)
					if (this.params.centeredSlides)
						(this.visibleSlides || []).forEach((e) => {
							s.push(e);
						});
					else
				...
				(r || 0 === r) && (this.wrapperEl.style.height = `${r}px`);
			},
			updateSlidesOffset: function () {
				...
				for (let a = 0; a < t.length; a += 1)
					t[a].swiperSlideOffset =
						(this.isHorizontal() ? t[a].offsetLeft : t[a].offsetTop) -
						s -
			...
			updateSlidesProgress: function (e) {
				...
				const s = this.params,
					{ slides: a, rtlTranslate: i, snapGrid: r } = this;
				...
				for (let e = 0; e < a.length; e += 1) {
					...
					const c =
							(n + (s.centeredSlides ? this.minTranslate() : 0) - d) /
							(o.swiperSlideSize + l),
						p =
							(n - r[0] + (s.centeredSlides ? this.minTranslate() : 0) - d) /
							(o.swiperSlideSize + l),
						u = -(n - d),
						m = u + this.slidesSizesGrid[e],
						h = u >= 0 && u <= this.size - this.slidesSizesGrid[e],
						f =
							(u >= 0 && u < this.size - 1) ||
							(m > 1 && m <= this.size) ||
							(u <= 0 && m >= this.size);
					f && (this.visibleSlides.push(o), this.visibleSlidesIndexes.push(e)),
			...
			updateProgress: function (e) {
				...
				let { progress: i, isBeginning: r, isEnd: n, progressLoop: l } = this;
				const o = r,
					d = n;
				if (0 === a) (i = 0), (r = !0), (n = !0);
				else {
					i = (e - this.minTranslate()) / a;
					const s = Math.abs(e - this.minTranslate()) < 1,
						l = Math.abs(e - this.maxTranslate()) < 1;
					(r = s || i <= 0), (n = l || i >= 1), s && (i = 0), l && (i = 1);
				}
				if (s.loop) {
					const s = this.getSlideIndexByData(0),
						a = this.getSlideIndexByData(this.slides.length - 1),
						i = this.slidesGrid[s],
						r = this.slidesGrid[a],
			...
			updateSlidesClasses: function () {
				const { slides: t, params: s, slidesEl: a, activeIndex: i } = this,
					r = this.virtual && s.virtual.enabled,
					n = this.grid && s.grid && s.grid.rows > 1,
			...
			updateActiveIndex: function (e) {
				...
				let o,
					d = e;
				const c = (e) => {
					let s = e - this.virtual.slidesBefore;
					return (
						s < 0 && (s = this.virtual.slides.length + s),
						s >= this.virtual.slides.length &&
							(s -= this.virtual.slides.length),
						s
					);
				};
				...
				if ((o >= a.length && (o = a.length - 1), d === r && !this.params.loop))
					return void (
						o !== l && ((this.snapIndex = o), this.emit("snapIndexChange"))
					);
				if (
					d === r &&
					this.params.loop &&
					...
					return void (this.realIndex = c(d));
				const p = this.grid && i.grid && i.grid.rows > 1;
				let u;
				if (this.virtual && i.virtual.enabled && i.loop) u = c(d);
				else if (p) {
					const e = this.slides.filter((e) => e.column === d)[0];
					let s = parseInt(e.getAttribute("data-swiper-slide-index"), 10);
					Number.isNaN(s) && (s = Math.max(this.slides.indexOf(e), 0)),
						(u = Math.floor(s / i.grid.rows));
				} else if (this.slides[d]) {
					const e = this.slides[d].getAttribute("data-swiper-slide-index");
					u = e ? parseInt(e, 10) : d;
				} else u = d;
				Object.assign(this, {
					previousSnapIndex: l,
					...
					this.initialized && N(this),
					this.emit("activeIndexChange"),
					this.emit("snapIndexChange"),
					(this.initialized || this.params.runCallbacksOnInit) &&
						(n !== u && this.emit("realIndexChange"), this.emit("slideChange"));
			},
		...
		var Y = {
			...
			setTranslate: function (e, t) {
				const { rtlTranslate: a, params: i, wrapperEl: r, progress: n } = this;
				let l,
					o = 0,
					d = 0;
				this.isHorizontal() ? (o = a ? -e : e) : (d = e),
					i.roundLengths && ((o = Math.floor(o)), (d = Math.floor(d))),
					(this.previousTranslate = this.translate),
					(this.translate = this.isHorizontal() ? o : d),
					i.cssMode
						...
						: i.virtualTranslate ||
							(this.isHorizontal()
								...
								: (d -= this.cssOverflowAdjustment()),
							(r.style.transform = `translate3d(${o}px, ${d}px, 0px)`));
				const c = this.maxTranslate() - this.minTranslate();
				(l = 0 === c ? 0 : (e - this.minTranslate()) / c),
					l !== n && this.updateProgress(e),
				...
				if (
					...
					if (0 === t) l[e ? "scrollLeft" : "scrollTop"] = -c;
						...
						if (!r.support.smoothScroll)
							return (
								f({ swiper: r, targetPosition: -c, side: e ? "left" : "top" }),
								!0
							);
		...
		var q = {
			...
			slideToLoop: function (e, t, s, a) {
				...
				if (this.params.loop)
					if (this.virtual && this.params.virtual.enabled)
						...
						let e;
						if (r) {
							const t = n * this.params.grid.rows;
							e = this.slides.filter(
								(e) => 1 * e.getAttribute("data-swiper-slide-index") === t,
							)[0].column;
						} else e = this.getSlideIndexByData(n);
						const t = r
								? Math.ceil(this.slides.length / this.params.grid.rows)
								: this.slides.length,
							{ centeredSlides: s } = this.params;
						let l = this.params.slidesPerView;
						"auto" === l
							? (l = this.slidesPerViewDynamic())
							: ((l = Math.ceil(parseFloat(this.params.slidesPerView, 10))),
								s && l % 2 === 0 && (l += 1));
						let o = t - e < l;
						if (
							(s && (o = o || e < Math.ceil(l / 2)),
							a && s && "auto" !== this.params.slidesPerView && !r && (o = !1),
							o)
						) {
							const a = s
								? e < this.activeIndex
									? "prev"
									: "next"
								: e - this.activeIndex - 1 < this.params.slidesPerView
									? "next"
									: "prev";
							this.loopFix({
								direction: a,
								...
								slideRealIndex: "next" === a ? this.realIndex : void 0,
							});
						}
						if (r) {
							const e = n * this.params.grid.rows;
							n = this.slides.filter(
								(t) => 1 * t.getAttribute("data-swiper-slide-index") === e,
							)[0].column;
						} else n = this.getSlideIndexByData(n);
					}
				return (
					requestAnimationFrame(() => {
						this.slideTo(n, t, s, a);
					}),
					this
				);
			},
			slideNext: function (e, t, s) {
				void 0 === t && (t = !0);
				const { enabled: i, params: r, animating: n } = this;
				if (!i || this.destroyed) return this;
				...
				const o = this.activeIndex < r.slidesPerGroupSkip ? 1 : l,
				...
				if (r.loop) {
					...
					if (
						...
						return (
							requestAnimationFrame(() => {
								this.slideTo(this.activeIndex + o, e, t, s);
							}),
							!0
						);
				}
			...
			slidePrev: function (e, t, s) {
				...
				if (!o || this.destroyed) return this;
				void 0 === e && (e = this.params.speed);
				const c = this.virtual && i.virtual.enabled;
				if (i.loop) {
				...
				const u = p(l ? this.translate : -this.translate),
					m = r.map((e) => p(e));
				...
				if (
					...
					const i =
						this.params.virtual?.enabled && this.virtual
							? this.virtual.slides.length - 1
							: this.slides.length - 1;
					return this.slideTo(i, e, t, s);
				}
				return i.loop && 0 === this.activeIndex && i.cssMode
					? (requestAnimationFrame(() => {
							this.slideTo(f, e, t, s);
						}),
						!0)
					: this.slideTo(f, e, t, s);
			},
			...
			slideToClickedSlide: function () {
				if (this.destroyed) return;
				const { params: t, slidesEl: s } = this,
					a =
				...
				let i,
					r = this.clickedIndex;
				const n = this.isElement ? "swiper-slide" : `.${t.slideClass}`;
				if (t.loop) {
		...
		var F = {
			loopCreate: function (e) {
				const { params: s, slidesEl: a } = this;
				...
				const i = () => {
					...
					r = this.grid && s.grid && s.grid.rows > 1,
					n = s.slidesPerGroup * (r ? s.grid.rows : 1),
					l = this.slides.length % n !== 0,
					o = r && this.slides.length % s.grid.rows !== 0,
					d = (e) => {
						for (let a = 0; a < e; a += 1) {
							const e = this.isElement
								? b("swiper-slide", [s.slideBlankClass])
								: b("div", [s.slideClass, s.slideBlankClass]);
							this.slidesEl.append(e);
						}
					};
				if (l) {
					if (s.loopAddBlankSlides) {
						d(n - (this.slides.length % n)),
							this.recalcSlides(),
							this.updateSlides();
					} else w();
					i();
					...
					if (s.loopAddBlankSlides) {
						d(s.grid.rows - (this.slides.length % s.grid.rows)),
							this.recalcSlides(),
							this.updateSlides();
					} else w();
					i();
			...
			loopFix: function (e) {
				...
				if (
					...
					this.virtual && m.virtual.enabled)
				)
					return (
						s &&
							(m.centeredSlides || 0 !== this.snapIndex
								? m.centeredSlides && this.snapIndex < m.slidesPerView
									? this.slideTo(
						...
						void this.emit("loopFix")
					);
				let f = m.slidesPerView;
				"auto" === f
					? (f = this.slidesPerViewDynamic())
				...
				v % g !== 0 && (v += g - (v % g)),
					...
					(this.loopedSlides = v);
				const b = this.grid && m.grid && m.grid.rows > 1;
				(d.length < f + v || (b && "row" === m.grid.fill)) && w();
				const y = [],
					E = [];
				let x = this.activeIndex;
				void 0 === r
					? (r = this.getSlideIndex(
					...
					"auto" === m.slidesPerView
						...
						: b &&
							...
							this.slides.forEach((e, t) => {
								this.grid.updateSlide(t, e, this.slides);
							}),
					m.watchSlidesProgress && this.updateSlidesOffset(),
					s)
				)
					if (y.length > 0 && T) {
						if (void 0 === t) {
							const e = this.slidesGrid[x],
								t = this.slidesGrid[x + M] - e;
							l
								? this.setTranslate(this.translate - t)
								: (this.slideTo(x + Math.ceil(M), 0, !1, !0),
									i &&
										((this.touchEventsData.startTranslate =
											this.touchEventsData.startTranslate - t),
										(this.touchEventsData.currentTranslate =
											this.touchEventsData.currentTranslate - t)));
						} else if (i) {
							const e = b ? y.length / m.grid.rows : y.length;
							this.slideTo(this.activeIndex + e, 0, !1, !0),
								(this.touchEventsData.currentTranslate = this.translate);
						}
					} else if (E.length > 0 && S)
						if (void 0 === t) {
							const e = this.slidesGrid[x],
								t = this.slidesGrid[x - C] - e;
							l
								? this.setTranslate(this.translate - t)
								: (this.slideTo(x - C, 0, !1, !0),
									i &&
										((this.touchEventsData.startTranslate =
											this.touchEventsData.startTranslate - t),
										(this.touchEventsData.currentTranslate =
				...
				if (
					...
					Array.isArray(this.controller.control)
						? this.controller.control.forEach((t) => {
								!t.destroyed &&
									t.params.loop &&
									t.loopFix({
										...e,
		...
		function _(e) {
			...
			if ("pointerdown" === a.type) {
				...
				"touchstart" === a.type &&
					...
					(i.touchId = a.targetTouches[0].identifier);
			if ("touchstart" === a.type)
				return void V(this, a, a.targetTouches[0].pageX);
			const { params: n, touches: o, enabled: d } = this;
			if (!d) return;
			if (!n.simulateTouch && "mouse" === a.pointerType) return;
			if (this.animating && n.preventInteractionOnTransition) return;
			...
			p.matches(i.focusableElements) &&
				...
				s.activeElement?.matches(i.focusableElements) &&
					s.activeElement !== p &&
					("mouse" === a.pointerType ||
						("mouse" !== a.pointerType && !p.matches(i.focusableElements))) &&
					s.activeElement.blur();
			const b = w && this.allowTouchMove && n.touchStartPreventDefault;
		...
		function j(e) {
			const t = r(),
				...
				{ params: i, touches: n, rtlTranslate: l, enabled: o } = this;
			if (!o) return;
			...
			if (!this.allowTouchMove)
				return (
					p.target.matches(a.focusableElements) || (this.allowClick = !1),
					void (
						a.isTouched &&
						(Object.assign(n, {
							startX: u,
			...
			if (i.touchReleaseOnEdges && !i.loop)
				if (this.isVertical()) {
					...
					(u < n.startX && this.translate <= this.maxTranslate()) ||
					(u > n.startX && this.translate >= this.minTranslate())
				)
					return;
			if (
			...
			a.allowTouchCallbacks && this.emit("touchMove", p),
			...
			if (
				(a.isScrolling && this.emit("touchMoveOpposite", p),
			...
			if (
				...
				g > 0
					? (b &&
							...
							a.currentTranslate >
								(i.centeredSlides
									? this.minTranslate() -
										...
										("auto" !== i.slidesPerView &&
										this.slides.length - i.slidesPerView >= 2
											? this.slidesSizesGrid[this.activeIndex + 1] +
						...
						a.currentTranslate > this.minTranslate() &&
							((E = !1),
							i.resistance &&
								(a.currentTranslate =
									this.minTranslate() -
									1 +
									(-this.minTranslate() + a.startTranslate + g) ** x)))
					: g < 0 &&
						(b &&
							y &&
							a.allowThresholdMove &&
						...
						a.currentTranslate < this.maxTranslate() &&
							...
							i.resistance &&
								(a.currentTranslate =
									this.maxTranslate() +
									1 -
									(this.maxTranslate() - a.startTranslate - g) ** x))),
			...
			i.followFinger &&
				!i.cssMode &&
				(((i.freeMode?.enabled && this.freeMode) || i.watchSlidesProgress) &&
					(this.updateActiveIndex(), this.updateSlidesClasses()),
				i.freeMode?.enabled && this.freeMode && this.freeMode.onTouchMove(),
		...
		function W(e) {
			...
			if (
				(s.allowTouchCallbacks && this.emit("touchEnd", i),
				(s.allowTouchCallbacks = !1),
				!s.isTouched)
			)
				return (
					s.isMoved && r.grabCursor && this.setGrabCursor(!1),
					(s.isMoved = !1),
			...
			if (this.allowClick) {
				const e = i.path || i.composedPath?.();
				this.updateClickedSlide(e?.[0] || i.target, e),
					this.emit("tap click", i),
					m < 300 &&
						u - s.lastClickTime < 300 &&
						this.emit("doubleTap doubleClick", i);
			}
			if (
				((s.lastClickTime = c()),
				d(() => {
			...
			if (
				...
				return;
			if (r.freeMode?.enabled)
				return void this.freeMode.onTouchEnd({ currentPos: h });
			const f = h >= -this.maxTranslate() && !this.params.loop;
			let g = 0,
				v = this.slidesSizesGrid[0];
			for (
				let e = 0;
				e < o.length;
			...
			r.rewind &&
				(this.isBeginning
					? (b =
							r.virtual?.enabled && this.virtual
								? this.virtual.slides.length - 1
								: this.slides.length - 1)
					: this.isEnd && (w = 0));
			const y = (h - o[g]) / v,
			...
			if (m > r.longSwipesMs) {
				if (!r.longSwipes) return void this.slideTo(this.activeIndex);
				"next" === this.swipeDirection &&
					(y >= r.longSwipesRatio
						? this.slideTo(r.rewind && this.isEnd ? w : g + E)
						: this.slideTo(g)),
					"prev" === this.swipeDirection &&
				...
				if (!r.shortSwipes) return void this.slideTo(this.activeIndex);
				this.navigation &&
				(i.target === this.navigation.nextEl ||
					i.target === this.navigation.prevEl)
					? i.target === this.navigation.nextEl
						? this.slideTo(g + E)
						: this.slideTo(g)
					: ("next" === this.swipeDirection &&
							this.slideTo(null !== w ? w : g + E),
						"prev" === this.swipeDirection && this.slideTo(null !== b ? b : g));
			}
		}
		function U() {
			...
			const { allowSlideNext: a, allowSlidePrev: i, snapGrid: r } = this,
				n = this.virtual && this.params.virtual.enabled;
			(this.allowSlideNext = !0),
				(this.allowSlidePrev = !0),
				this.updateSize(),
				this.updateSlides(),
		...
		const ie = {
				...
				breakpoints: {
					setBreakpoint: function () {
						const { realIndex: t, initialized: s, params: a, el: i } = this,
							r = a.breakpoints;
						if (!r || (r && 0 === Object.keys(r).length)) return;
						const n = this.getBreakpoint(
							r,
							this.params.breakpointsBase,
							this.el,
						);
						if (!n || this.currentBreakpoint === n) return;
						const l = (n in r ? r[n] : void 0) || this.originalParams,
							o = te(this, a),
							d = te(this, l),
							c = this.params.grabCursor,
							p = l.grabCursor,
							u = a.enabled;
						o && !d
							? (i.classList.remove(
							...
							c && !p
								...
								: !c && p && this.setGrabCursor(),
							["navigation", "pagination", "scrollbar"].forEach((t) => {
								if (void 0 === l[t]) return;
								const s = a[t]?.enabled,
									i = l[t]?.enabled;
								s && !i && this[t].disable(), !s && i && this[t].enable();
							});
						const h = l.direction && l.direction !== a.direction,
							f = a.loop && (l.slidesPerView !== a.slidesPerView || h),
							g = a.loop;
						h && s && this.changeDirection(), m(this.params, l);
						const v = this.params.enabled,
							w = this.params.loop;
						Object.assign(this, {
							...
							s &&
								(f
									? (this.loopDestroy(),
										...
										this.updateSlides())
									: !g && w
										? (this.loopCreate(t), this.updateSlides())
										: g && !w && this.loopDestroy()),
				...
				classes: {
					addClasses: function () {
						const { classNames: t, params: s, rtl: a, el: i, device: r } = this,
							n = ((e, t) => {
								const s = [];
								return (
									e.forEach((e) => {
						...
						t.push(...n), i.classList.add(...t), this.emitContainerClasses();
					},
		...
		class ne {
			constructor() {
				...
				return (
					...
					l.params?.onAny && l.onAny(l.params.onAny),
					Object.assign(l, {
			...
			mount(e) {
				...
				return (
					!i &&
						...
						((i = b("div", this.params.wrapperClass)),
						s.append(i),
						v(s, `.${this.params.slideClass}`).forEach((e) => {
							i.append(e);
						})),
					Object.assign(this, {
						el: s,
			...
			init(e) {
				...
				this.emit("beforeInit"),
					...
					this.attachEvents();
				const s = [...this.el.querySelectorAll('[loading="lazy"]')];
				return (
					this.isElement &&
						s.push(...this.hostEl.querySelectorAll('[loading="lazy"]')),
					s.forEach((e) => {
						e.complete
							? H(this, e)
		...
		function ce(e) {
			const { params: s, activeIndex: a, slidesEl: i } = this;
			s.loop && this.loopDestroy();
			let r = a + 1;
			const n = (e) => {
				if ("string" === typeof e) {
		...
		function pe(e, t) {
			const { params: a, activeIndex: i, slidesEl: r } = this;
			let n = i;
			a.loop &&
				((n -= this.loopedSlides), this.loopDestroy(), this.recalcSlides());
			...
			this.recalcSlides(),
				...
				(a.observer && !this.isElement) || this.update(),
				a.loop
					? this.slideTo(o + this.loopedSlides, 0, !1)
					: this.slideTo(o, 0, !1);
		}
		function ue(e) {
			const { params: s, activeIndex: a } = this;
			let i = a;
			s.loop && ((i -= this.loopedSlides), this.loopDestroy());
			let r,
				n = i;
			if ("object" === typeof e && "length" in e) {
				for (let s = 0; s < e.length; s += 1)
					(r = e[s]), this.slides[r]?.remove(), r < n && (n -= 1);
				n = Math.max(n, 0);
			} else
				(r = e),
					this.slides[r]?.remove(),
					r < n && (n -= 1),
					(n = Math.max(n, 0));
			this.recalcSlides(),
				s.loop && this.loopCreate(),
		...
		function he(e) {
			...
			a("beforeInit", () => {
				...
				s.classNames.push(`${s.params.containerModifierClass}${t}`),
					l?.() && s.classNames.push(`${s.params.containerModifierClass}3d`);
				const e = n ? n() : {};
					...
					s("init", () => {
						...
						s("destroy", () => {
							n && i.cancelAnimationFrame(n),
								r?.unobserve && t.el && (r.unobserve(t.el), (r = null)),
		...
		const we = [
			...
			(e) => {
				...
				function c() {
					...
					Object.assign(t.navigation, { nextEl: s, prevEl: a }),
						...
						(a = C(a));
					const i = (s, a) => {
						s?.addEventListener("click", "next" === a ? d : o),
				...
				function u() {
					...
					if ("bullets" === e.type) {
						let a = t.params.loop
							...
							: t.snapGrid.length;
						t.params.freeMode?.enabled && a > s && (a = s);
						for (let s = 0; s < a; s += 1)
							e.renderBullet
				...
				function z(e) {
					...
					if (!m.slideEl) {
						e?.target &&
							...
							m.slideEl ||
								(t.params.virtual?.enabled && t.virtual
									? (m.slideEl = v(
											t.slidesEl,
			...
			(e) => {
				...
				s({ controller: { control: void 0, inverse: !1, by: "slide" } }),
					...
					a("setTranslate", (_e, s, a) => {
						t.controller.control &&
							!t.controller.control.destroyed &&
							t.controller.setTranslate(s, a);
					}),
					a("setTransition", (_e, s, a) => {
						t.controller.control &&
							!t.controller.control.destroyed &&
			...
			(e) => {
				...
				function v(e) {
					...
					if (
						...
						if (t.navigation?.prevEl && t.navigation.nextEl) {
						...
						t.pagination &&
							a.matches(oe(t.params.pagination.bulletClass)) &&
							a.click();
					}
				}
				function w() {
					return t.pagination?.bullets?.length;
				}
				function y() {
				...
				const E = (e, t, s) => {
					...
					I = () => {
						...
						var n;
						const o = t.params.autoplay?.enabled ? "off" : "polite";
						var d;
						(d = i),
							C(a).forEach((e) => {
								e.setAttribute("id", d);
						...
						if (
							((c = C(c)),
							(p = C(p)),
							c?.forEach((t) => E(t, i, e.nextSlideMessage)),
							p?.forEach((t) => E(t, i, e.prevSlideMessage)),
							y())
						) {
						...
						t.params.a11y.enabled &&
							(() => {
								...
								(e = C(e)),
									...
									s?.forEach((e) => e.removeEventListener("keydown", v)),
									y() &&
										C(t.pagination.el).forEach((e) => {
			...
			(e) => {
				...
				i("init", () => {
					t.params.hashNavigation.enabled &&
						(() => {
							if (!t.params.hashNavigation.enabled || t.params.history?.enabled)
								return;
							n = !0;
							const e = o.location.hash.replace("#", "");
							if (e) {
			...
			(e) => {
				...
				let d,
					...
					f,
					g,
					v = o?.autoplay ? o.autoplay.delay : 3e3,
					w = o?.autoplay ? o.autoplay.delay : 3e3,
					b = Date.now();
				function y(e) {
					a &&
						!a.destroyed &&
						...
						g || e.detail?.bySwiperTouchMove || C());
				}
				const E = () => {
						if (a.destroyed || !a.autoplay.running) return;
						a.autoplay.paused ? (c = !0) : c && ((w = d), (c = !1));
						const e = a.autoplay.paused ? d : b + w - Date.now();
				...
				n("init", () => {
					...
					n("beforeTransitionStart", (_e, _t, s) => {
						!a.destroyed &&
							a.autoplay.running &&
			...
			(e) => {
				...
				function l() {
					...
					const s = e.clickedIndex,
						a = e.clickedSlide;
					if (a?.classList.contains(t.params.thumbs.slideThumbActiveClass))
						return;
					if (null == s) return;
					let i;
					(i = e.params.loop
				...
				function d(e) {
					...
					if (
						...
						s.params.loop || s.params.virtual?.enabled)
					)
						for (let e = 0; e < i; e += 1)
							v(
								s.slidesEl,
									...
									a = () => {
										const a =
											"string" === typeof e.swiper
												...
												: e.swiper;
										if (a?.swiper) (e.swiper = a.swiper), o(), d(!0);
										else if (a) {
											const s = `${t.params.eventsPrefix}init`,
												i = (r) => {
													(e.swiper = r.detail[0]),
						...
						p.shadow &&
							(u
								...
								: ((h = e.querySelector(".swiper-cube-shadow")),
									h || ((h = b("div", "swiper-cube-shadow")), e.append(h))));
						for (let e = 0; e < a.length; e += 1) {
							const t = a[e];
							let s = e;
							m &&
