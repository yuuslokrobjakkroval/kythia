				...
				1009: (_e, _t, n) => {
					!(function e(t, n, o) {
					...
					})(
						{
									...
									!(function () {
										this.jKanban = function () {
											...
											arguments[0] &&
												...
												(this.init = () => {
													!(() => {
														...
														t.classList.add("kanban-container"),
															(e.container = t),
															Object.hasOwn(
																document.querySelector(e.options.element)
																	.dataset,
																"board",
															)
														...
														window.innerWidth > e.options.responsive &&
															...
															(e.drake = e
																.dragula(e.boardContainer, {
																	moves: (_t, _n, o, _i) => e.__getCanMove(o),
																	revertOnSpill: !0,
																})
																.on("cancel", (_t, _n, _o) => {
																	e.enableAllBoards();
														...
														n || e.options.boards.push(p),
															e.options.responsivePercentage ||
																("" === e.container.style.width
																	? (e.container.style.width =
																			parseInt(o, 10) +
																			2 * parseInt(e.options.gutter, 10) +
																			"px")
																	: (e.container.style.width =
																			parseInt(e.container.style.width, 10) +
																			parseInt(o, 10) +
																			2 * parseInt(e.options.gutter, 10) +
																			"px"));
												...
												(this.findBoard = (t) =>
													e.element.querySelector(`[data-id="${t}"]`)),
												(this.getParentBoardID = (t) => (
													"string" === typeof t &&
												...
												(this.findElement = (t) =>
													e.element.querySelector(`[data-eid="${t}"]`)),
												(this.getBoardElements = (t) =>
							...
							2: [
								(_e, t, _n) => {
									t.exports = (e, t) => Array.prototype.slice.call(e, t);
								},
								{},
							],
							3: [
								...
								(e, t, _n) => {
									...
									t.exports = (e, t) => {
										...
										return (
											void 0 === e && (e = {}),
											(e.on = (t, n) => (
												r[t] ? r[t].push(n) : (r[t] = [n]), e
											)),
											(e.once = (t, n) => ((n._once = !0), e.on(t, n), e)),
											(e.off = function (t, n) {
									...
									(function (n) {
										(() => {
											var o = e("custom-event"),
												i = e("./eventmap"),
												r = n.document,
												a = (e, t, n, o) => e.addEventListener(t, n, o),
												c = (e, t, n, o) => e.removeEventListener(t, n, o),
												d = [];
											function s(e, t, n) {
												var o = ((e, t, n) => {
													var o, i;
											...
											t.exports = function (e, t) {
												...
												function G(e) {
													if (A.dragging) {
														...
														!1 === i &&
															t &&
															(L ? o?.removeChild(L) : y.insertBefore(n, x)),
															i || t
																? A.emit("cancel", n, y, y)
																: A.emit("drop", n, o, y, k),
															V();
