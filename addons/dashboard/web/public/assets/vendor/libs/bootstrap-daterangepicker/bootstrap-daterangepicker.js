								...
								((t, e) => {
									...
									return (
										(a.prototype = {
											...
											renderCalendar: function (a) {
												...
												if (this.showDropdowns) {
													for (
														var P = i[1][1].month(),
															x = i[1][1].year(),
															M = C?.year() || this.maxYear,
															S = v?.year() || this.minYear,
															I = x === S,
															B = x === M,
												...
												if (
													...
													(this.showWeekNumbers || this.showISOWeekNumbers) &&
														(Y +=
															...
															"</th>"),
													e.each(this.locale.daysOfWeek, (_t, e) => {
														Y += `<th>${e}</th>`;
													}),
													(Y += "</tr>"),
													(Y += "</thead>"),
											...
											clickApply: function (_t) {
												this.hide(),
													this.element.trigger("apply.daterangepicker", this);
											},
											clickCancel: function (_t) {
