				...
				5529: (t) => {
					t.exports = (() => {
						...
						(p.prototype.eventElement = function (t) {
							var e = this.eventElements.filter((e) => e.element === t)[0];
						...
						function L(t) {
							...
							(t.containerWidth = Math.floor(i.width)),
								...
								e.contains(t.scrollbarXRail) ||
									(o(e, s.element.rail("x")).forEach((t) => l(t)),
									e.appendChild(t.scrollbarXRail)),
								e.contains(t.scrollbarYRail) ||
									(o(e, s.element.rail("y")).forEach((t) => l(t)),
						...
						function H(t) {
							var e = t.element,
								r = () => n(e, ":hover"),
								i = () =>
									n(t.scrollbarX, ":focus") || n(t.scrollbarY, ":focus");
							function l(r, i) {
								...
								e.settings.swipeEasing &&
									...
									(i.easingLoop = setInterval(() => {
										e.isInitialized
											? clearInterval(i.easingLoop)
											: i.speed.x || i.speed.y
												? Math.abs(i.speed.x) < 0.01 &&
													Math.abs(i.speed.y) < 0.01
													? clearInterval(i.easingLoop)
						...
						var A = () => ({
							...
							k = function (i, n) {
								...
								var a,
									c,
									h = () => i.classList.add(s.state.focus),
									u = () => i.classList.remove(s.state.focus);
								...
								(this.scrollbarXBottom = parseInt(d.bottom, 10)),
									Number.isNaN(this.scrollbarXBottom)
								...
								(this.scrollbarYRight = parseInt(f.right, 10)),
									Number.isNaN(this.scrollbarYRight)
									...
									(this.isAlive = !0),
									this.settings.handlers.forEach((t) => P[t](this)),
						...
						return (
							...
							(k.prototype.onScroll = function (_t) {
								this.isAlive &&
									(L(this),
