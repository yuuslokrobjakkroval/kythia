					...
					e.exports = ((e) => {
							...
							var i =
									...
									function (e) {
										for (var t = 1; t < arguments.length; t++) {
											var o = arguments[t];
											for (var n in o) Object.hasOwn(o, n) && (e[n] = o[n]);
										}
										return e;
									},
								r = (n(o(1)), o(6)),
									...
									return w(b.disable) || t
										...
										: (b.disableMutationObserver ||
											...
											["complete", "interactive"].indexOf(document.readyState) >
												...
												? v(!0)
												: "load" === b.startEvent
													? window.addEventListener(b.startEvent, () => {
															v(!0);
														})
													: document.addEventListener(b.startEvent, () => {
															v(!0);
														}),
						...
						(_e, t, o) => {
							...
							var i = n(o(13)),
								r = (e, t) => {
									...
									switch (
										(a.offset &&
											!Number.isNaN(a.offset) &&
											(n = parseInt(a.offset, 10)),
										a.anchor &&
									...
									return (
										a.anchorPlacement || a.offset || Number.isNaN(t) || (n = t),
										o + n
									);
								};
							t.default = r;
						...
						(_e, t) => {
							...
							var o = (e) => {
								for (
									var t = 0, o = 0;
									e &&
									!Number.isNaN(e.offsetLeft) &&
									!Number.isNaN(e.offsetTop);
								)
									(t +=
						...
						(_e, t) => {
							...
							var o = (e) => (
								...
								Array.prototype.map.call(e, (e) => ({ node: e }))
							);
							t.default = o;
						},
					]);
