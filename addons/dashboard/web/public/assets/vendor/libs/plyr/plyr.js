					...
					"object" === typeof navigator &&
						(e.exports = (() => {
							...
							var l = { addCSS: !0, thumbWidth: 15, watch: !0 },
								r = (e) => (null != e ? e.constructor : null),
								o = (e, t) => !!(e && t && e instanceof t),
								c = (e) => null == e,
								u = (e) => r(e) === Object,
								h = (e) => r(e) === String,
								d = (e) => Array.isArray(e),
								...
								p = {
									nullOrUndefined: c,
									object: u,
									number: (e) => r(e) === Number && !Number.isNaN(e),
									string: h,
									boolean: (e) => r(e) === Boolean,
									function: (e) => r(e) === Function,
									array: d,
									nodeList: m,
									element: (e) => o(e, Element),
									event: (e) => o(e, Event),
									empty: (e) =>
										c(e) ||
											...
											},
											{
												...
												value: function (e) {
													...
													["touchstart", "touchmove", "touchend"].forEach(
														(e) => {
															this.element[i](e, (e) => this.set(e), !1);
														},
													);
												},
											},
											{
												...
												value: function (t) {
													...
													var i,
														...
														c =
															((100 / o.width) * (this.config.thumbWidth / 2)) /
															100;
													return (
										...
										[
											{
												...
												value: function (t) {
													...
													if (p.string(t) && n.watch) {
														var r = new MutationObserver((i) => {
															Array.from(i).forEach((i) => {
																Array.from(i.addedNodes).forEach((i) => {
																	p.element(i) &&
																		((e, t) =>
																			function () {
																				return Array.from(
													...
													return s.map((t) => new e(t, i));
												},
											},
											{
												key: "enabled",
												get: () => "ontouchstart" in document.documentElement,
											},
										],
									),
									e
							...
							function O(e, t, i) {
								...
								return (
									E.object(t) && $(s, t), E.string(i) && (s.innerText = i), s
								);
							}
							function _(e, t, i, s) {
											...
											set(t) {
												if (e.quality !== t) {
													if (
														...
														E.function(e.config.quality.onChange)
													)
							...
							const Me = {
								...
								createButton(e, t) {
									...
									switch (
										...
										case "play-large":
											...
											break;
										default:
											E.empty(n.label) && (n.label = s),
												E.empty(n.icon) && (n.icon = e);
									}
									const a = O(n.element);
									return (
										n.toggle
										...
										$(a, i),
										"play" === s
											? (E.array(this.elements.buttons[s]) ||
								...
								timeUpdate(e) {
									const t =
										!E.element(this.elements.display.duration) &&
								...
								updateSetting(e, t, i) {
									...
									if (
										(E.element(a) || (a = s?.querySelector('[role="menu"]')),
										!E.element(a))
									)
										return;
									...
									const l = a?.querySelector(`[value="${n}"]`);
								...
								toggleMenu(e) {
									...
									if (E.boolean(e)) n = e;
										...
										const s = E.function(e.composedPath)
												? e.composedPath()[0]
												: e.target,
											a = t.contains(s);
								...
								create(e) {
									...
									return (
										ne(
											E.array(this.config.controls) ? this.config.controls : [],
										).forEach((l) => {
											if (
												("restart" === l &&
										...
										this.isHTML5 &&
											l.call(this, me.getQualityOptions.call(this)),
										r.call(this),
										c
									);
								},
								inject() {
									...
									if (
										...
										E.element(this.config.controls) ||
									...
									i.forEach((e) => {
										...
										a &&
											(t.addEventListener("mouseenter", () => {
												e.label ||
													((a.style.left = i), (a.innerHTML = e.label), r(!0));
											}),
												...
												.forEach((e) => {
													this.debug.log("Track added", e),
														...
														J.call(this, e, "cuechange", () =>
															Le.updateCues.call(this),
														);
												}),
											((a && this.language !== i) || !e.includes(n)) &&
												(Le.setLanguage.call(this, i),
												Le.toggle.call(this, t && a)),
											this.elements &&
												F(
													this.elements.container,
										...
										if (n !== i) {
											if (
												...
												return (
													...
													void Le.set.call(this, e.indexOf(t))
												);
											}
									...
									getLabel(e) {
										...
										return (
											!E.track(t) &&
												Y.textTracks &&
												this.captions.toggled &&
												(t = Le.getCurrentTrack.call(this)),
											E.track(t)
												? E.empty(t.label)
													? E.empty(t.language)
							...
							class Re {
											...
											if (this.supported)
												if (x.isIos && this.player.config.fullscreen.iosNative)
													this.player.isVimeo
														...
														: this.target.webkitEnterFullscreen(),
														se(this.player.play());
												else if (!Re.nativeSupported || this.forceFallback)
								...
								static get property() {
									return "moz" === Re.prefix ? "FullScreen" : "Fullscreen";
								}
								get supported() {
									return [
							...
							const Ve = {
								...
								build() {
									...
									E.element(this.elements.controls) ||
										...
										this.poster &&
											Ve.setPoster.call(this, this.poster, !1).catch(() => {}),
								...
								setTitle() {
									...
									if (
										...
										if (!E.element(e)) return;
										const t = E.empty(this.config.title)
												? "video"
												: this.config.title,
								...
								migrateStyles() {
									Object.values({ ...this.media.style })
										.filter(
											(e) =>
												!E.empty(e) && E.string(e) && e.startsWith("--plyr"),
										)
										.forEach((e) => {
								...
								constructor(t) {
									e(this, "firstTouch", () => {
										...
										e(this, "media", () => {
											...
											if (
												...
												J.call(
													...
													(t) => Ve.checkPlaying.call(e, t),
												),
												J.call(
													e,
													e.media,
													"waiting canplay seeked playing",
													(t) => Ve.checkLoading.call(e, t),
												),
										...
										e(this, "proxy", (e, t, i) => {
											...
											let a = !0;
											E.function(n) && (a = n.call(s, e)),
												!1 !== a && E.function(t) && t.call(s, e);
										}),
											...
											this.bind(
												...
												this.bind(
													...
													() => {
														...
														t?.loaded && t.endMove(!1, !0);
													},
												),
												this.bind(t.progress, "mousedown touchstart", (t) => {
													const { previewThumbnails: i } = e;
													i?.loaded && i.startScrubbing(t);
												}),
												this.bind(t.progress, "mouseup touchend", (t) => {
													const { previewThumbnails: i } = e;
													i?.loaded && i.endScrubbing(t);
												}),
												x.isWebKit &&
													Array.from(B.call(e, 'input[type="range"]')).forEach(
														(t) => {
															this.bind(t, "input", (t) =>
										...
										if (c) {
											...
											if (E.element(n)) {
												const { editable: s } = t.config.selectors,
													{ seek: a } = i.inputs;
												if (n !== a && U(n, s)) return;
												if (" " === e.key && U(n, 'button, [role^="menuitem"]'))
													return;
											}
											switch (
												([
								...
								ready() {
									...
									t.customControls ||
										ke(pe(e.config.urls.vimeo.api, d)).then((t) => {
											!E.empty(t) &&
												t.thumbnail_url &&
												Ve.setPoster.call(e, t.thumbnail_url).catch(() => {});
										}),
											...
											this.destroy.call(
												...
												() => {
													...
													Object.assign(this, {
														...
														this.isHTML5 &&
															st.insertElements.call(this, "source", t),
							...
							class nt {
								constructor(t, i) {
									if (
										...
										e(this, "pause", () =>
											this.playing && E.function(this.media.pause)
												? this.media.pause()
												: null,
										),
										e(this, "togglePlay", (e) =>
									...
									switch (n) {
										case "div":
											if (
												((a = this.media.querySelector("iframe")), E.element(a))
											) {
												if (
								...
								get hasAudio() {
									return (
										...
										Boolean(this.media.audioTracks?.length)
									);
								}
								set speed(e) {
									let t = null;
								...
								set autoplay(e) {
									this.config.autoplay = E.boolean(e)
										? e
										: this.config.autoplay;
								}
								get autoplay() {
								...
								set pip(e) {
									...
									E.function(this.media.webkitSetPresentationMode) &&
										this.media.webkitSetPresentationMode(t ? $e : Oe),
							...
							var at;
							return (
								(nt.defaults = ((at = Ie), JSON.parse(JSON.stringify(at)))), nt
							);
						})());
				},
			},
