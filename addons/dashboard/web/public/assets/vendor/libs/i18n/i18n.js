		...
		return (
			(() => {
													...
													n.push(t),
														h &&
															...
															a.ordinal &&
																...
																n.push(
																	t +
																		e.replace(s, this.options.pluralSeparator),
																),
															p && n.push(t + o));
												}
											}
				...
				class D {
					...
					interpolate(t, n, s, i) {
						let r, a, l;
						const c = this.options?.interpolation?.defaultVariables || {},
							u = (e) => {
											...
											: s.split(";").forEach((e) => {
													if (e) {
														...
														o[i] || (o[i] = s),
															"false" === s && (o[i] = !1),
															"true" === s && (o[i] = !0),
															Number.isNaN(s) || (o[i] = parseInt(s, 10));
													}
												});
								}
					...
					saveMissing(e, t, o, n, s) {
						...
						if (
							...
							if (null != o && "" !== o) {
								...
								e?.[0] && this.store.addResource(e[0], t, o, n);
							}
						} else
							this.logger.warn(
					...
					[
										...
										ne(
											ne(
												{},
												{
													...
													parsePayload: (_e, t, o) => ie({}, t, o || ""),
													parseLoadPayload: (_e, _t) => {},
													request: ee,
						...
						},
						{
							...
							value: function (e, t, o, n, s) {
								...
								"function" === typeof this.options.loadPath &&
									...
									(a = ((e) => !!e && "function" === typeof e.then)((i = a))
										? i
						...
						},
						{
							...
							value: function (e, t, o, n) {
								var i = "string" === typeof o ? [o] : o,
									r = "string" === typeof n ? [n] : n,
									a = this.options.parseLoadPayload(i, r);
								this.options.request(this.options, e, a, (i, r) => {
							...
							value: function (e, t, o, n, s) {
								if (this.options.addPath) {
									...
									var r = this.options.parsePayload(t, o, n),
										...
										c = [];
									e.forEach((o) => {
										var n = this.options.addPath;
										"function" === typeof this.options.addPath &&
											(n = this.options.addPath(o, t));
										var u = this.services.interpolator.interpolate(n, {
											lng: o,
											ns: t,
										});
										this.options.request(this.options, u, r, (t, o) => {
											(a += 1),
												l.push(t),
												c.push(o),
						...
						},
						{
							...
							value: function () {
								...
								if (!i || "cimode" !== i.toLowerCase()) {
									var r = [],
										a = (e) => {
											n.toResolveHierarchy(e).forEach((e) => {
												r.indexOf(e) < 0 && r.push(e);
											});
										};
									a(i),
										this.allOptions.preload?.forEach((e) => a(e)),
										r.forEach((t) => {
											this.allOptions.ns.forEach((e) => {
												o.read(t, e, "read", null, null, (n, i) => {
													n &&
														s.warn(
															"loading namespace "
				...
				var ye = {
					name: "localStorage",
					lookup(e) {
						const { lookupLocalStorage: t } = e;
						if (t && me()) return window.localStorage.getItem(t) || void 0;
					},
					cacheUserLanguage(e, t) {
						const { lookupLocalStorage: o } = t;
				...
				var xe = {
						name: "sessionStorage",
						lookup(e) {
							const { lookupSessionStorage: t } = e;
							if (t && be()) return window.sessionStorage.getItem(t) || void 0;
						},
						cacheUserLanguage(e, t) {
							const { lookupSessionStorage: o } = t;
					...
					Oe = {
						name: "subdomain",
						lookup(e) {
							const { lookupFromSubdomainIndex: t } = e;
