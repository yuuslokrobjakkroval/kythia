					...
					!((r, s, _o, a) => {
						...
						function m(t, e, n) {
							...
							if (t)
								...
								else for (i in t) Object.hasOwn(t, i) && e.call(n, t[i], i, t);
						}
						function g(t, e, n) {
							...
							return function () {
								...
								return s?.call(r.console, i, n), t.apply(this, arguments);
							};
						}
						u =
							"function" !== typeof Object.assign
								? function (t) {
										...
										for (var e = Object(t), n = 1; n < arguments.length; n++) {
											var i = arguments[n];
											if (i !== a && null !== i)
												for (var r in i) Object.hasOwn(i, r) && (e[r] = i[r]);
										}
										return e;
									}
								: Object.assign;
						var y = g(
							...
							T = g((t, e) => y(t, e, !0), "merge", "Use `assign`.");
						function E(t, e, n) {
							var i,
								r = e.prototype;
						...
						function w(t, e, n) {
							...
							return n && (i = e ? i.sort((t, n) => t[e] > n[e]) : i.sort()), i;
						}
						function M(t, e) {
							for (
						...
						function L(t, e) {
							(this.manager = t),
								...
								(this.domHandler = (e) => {
									I(t.options.enable, [t]) && this.handler(e);
								}),
								this.init();
						}
						function H(t, e, n) {
						...
						function pt(t, e) {
							...
							var r,
								...
								a = [],
								u = this.target;
							if (((s = n.filter((t) => P(t.target, u))), 1 === e))
						...
						(Ct.prototype = {
							...
							set: function (t) {
								return (
									u(this.options, t), this.manager?.touchAction.update(), this
								);
							},
						...
						(qt.prototype = {
							...
							off: function (t, e) {
								if (t !== a) {
									...
									return (
										m(C(t), (t) => {
											e ? n[t]?.splice(D(n[t], e), 1) : delete n[t];
										}),
										this
									);
								}
							...
							((void 0 !== r
								...
								: "undefined" !== typeof self
									? self
									: {}).Hammer = Wt),
							(i = (() => Wt).call(e, n, e, t)) === a || (t.exports = i);
					})(window, document);
				},
			},
			e = {};
