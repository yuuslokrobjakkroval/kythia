					...
					!(() => {
						(s = [i(1145)]),
							(r = (e, t) => {
								...
								(e.jstree = {
									...
									(e.jstree.create = (t, r) => {
										...
										return (
											...
											a?.plugins && (r.plugins = a.plugins),
											e.each(r.plugins, (e, t) => {
										...
										return (
											...
											(r = r.data("jstree"))
												...
												: e(".jstree").each(function () {
														...
														if (r?._model.data[t]) return (i = r), !1;
													}),
											i
										);
									}),
									...
									(e.expr.pseudos.jstree = e.expr.createPseudo(
										(_i) => (i) =>
											e(i).hasClass("jstree") && e(i).data("jstree") !== t,
									)),
									...
									(e.jstree.core.prototype = {
											...
											this.element
												.on("dblclick.jstree", (e) => {
													if (
														...
														return !0;
													if (d.selection?.empty) d.selection.empty();
												...
												.on(
													...
													function (e) {
														e.target === this.element[0] &&
															(e.preventDefault(), (r = Date.now()));
													}.bind(this),
												)
												.on("mousedown.jstree", ".jstree-ocl", (e) => {
													e.preventDefault();
												})
												.on(
													"click.jstree",
														...
														if ((t += s).length > 1) {
															if (
																(a.slice(n).each(
																	((_i, r) => {
																		if (
																			0 === e(r).text().toLowerCase().indexOf(t)
																		)
																			return (
														...
														if (
															...
															if (
																(a.slice(n + 1).each(
																	((_t, i) => {
																		if (
																			e(i).text().toLowerCase().charAt(0) === s
																		)
																			return (
													...
													d = (e, t) => {
														...
														var i,
															...
															v = (e, i, r) => {
																...
																for (s in _)
																	Object.hasOwn(_, s) && (c.state[s] = _[s]);
																if (
																	(e?.data?.jstree?.icon &&
																	...
																	(c.icon !== t &&
																		...
																		"" !== c.icon) ||
																		(c.icon = !0),
																	e?.data && ((c.data = e.data), e.data.jstree))
																)
																	for (s in e.data.jstree)
																		Object.hasOwn(e.data.jstree, s) &&
																			(c.state[s] = e.data.jstree[s]);
																if (e && "object" === typeof e.state)
																	for (s in e.state)
																		Object.hasOwn(e.state, s) &&
																			(c.state[s] = e.state[s]);
																if (e && "object" === typeof e.li_attr)
																	for (s in e.li_attr)
																		Object.hasOwn(e.li_attr, s) &&
															...
															j = (e, i, r) => {
																...
																_))
																	Object.hasOwn(_, s) && (d.state[s] = _[s]);
																if (
																	(e &&
																		(e.id || 0 === e.id) &&
																		(d.id = e.id.toString()),
																	e?.text && (d.text = e.text),
																	e?.data?.jstree?.icon &&
																	...
																	(d.icon !== t &&
																		...
																		"" !== d.icon) ||
																		(d.icon = !0),
																	e?.data && ((d.data = e.data), e.data.jstree))
																)
																	for (s in e.data.jstree)
																		Object.hasOwn(e.data.jstree, s) &&
										...
										_parse_model_from_html: function (i, r, s) {
											...
											for (o in this._model.default_state)
												Object.hasOwn(this._model.default_state, o) &&
										...
										_parse_model_from_flat_json: function (e, i, r) {
											...
											for (s in l) Object.hasOwn(l, s) && (h.state[s] = l[s]);
											if (
												(e?.data?.jstree?.icon && (h.icon = e.data.jstree.icon),
												(h.icon !== t && null !== h.icon && "" !== h.icon) ||
													(h.icon = !0),
												e?.data && ((h.data = e.data), e.data.jstree))
											)
												for (s in e.data.jstree)
													Object.hasOwn(e.data.jstree, s) &&
										...
										_parse_model_from_json: function (e, i, r) {
											...
											h))
												Object.hasOwn(h, s) && (d.state[s] = h[s]);
											if (
												(e && (e.id || 0 === e.id) && (d.id = e.id.toString()),
												e?.text && (d.text = e.text),
												e?.data?.jstree?.icon && (d.icon = e.data.jstree.icon),
										...
										get_top_selected: function (t) {
											...
											for (i in ((n = []), o)) Object.hasOwn(o, i) && n.push(i);
											return t
												? e.map(
														n,
														function (e) {
										...
										get_state: function () {
											...
											for (t in this._model.data)
												Object.hasOwn(this._model.data, t) &&
													t !== e.jstree.root &&
										...
										refresh: function (t, i) {
											...
											t ||
												...
												this.load_node(e.jstree.root, function (_t, i) {
													i &&
										...
										get_json: function (t, i, r) {
											...
											if (
												(i?.flat ? (n.parent = t.parent) : (n.children = []),
												i?.no_state)
											)
												delete n.state;
											else
												for (s in t.state)
													Object.hasOwn(t.state, s) &&
														(n.state[s] = t.state[s]);
											if (
												(i?.no_li_attr && delete n.li_attr,
												i?.no_a_attr && delete n.a_attr,
												i?.no_id &&
													(delete n.id,
													n.li_attr?.id && delete n.li_attr.id,
													n.a_attr?.id && delete n.a_attr.id),
												i?.flat && t.id !== e.jstree.root && r.push(n),
												!i || !i.no_children)
											)
										...
										check: function (t, i, r, s, a) {
											(i = i?.id ? i : this.get_node(i)),
												(r = r?.id ? r : this.get_node(r));
											...
											if (i.parent === u.id) {
												...
												for (
													...
													for (
														p = [],
															k = 0,
															b = (y = g._model.data[i.parents[v]].children_d)
																.length;
														k < b;
														k++
													)
												...
												for (
													...
													(this._model.data[i.children_d[v]].parents =
														this._model.data[i.children_d[v]].parents.slice(
															0,
															-1 * y,
														)),
										...
										get_buffer: () => ({ mode: s, node: r, inst: a }),
										can_paste: () => !1 !== s && !1 !== r,
										paste: function (e, t) {
											if (
												!(
									...
									(e.vakata = {}),
									(e.vakata.attributes = (t, i) => {
										t = e(t)[0];
										var r = i ? {} : [];
										return (
											t?.attributes &&
												e.each(t.attributes, (_t, s) => {
													-1 ===
									...
									(e.vakata.array_remove = (e, t) => (e.splice(t, 1), e)),
									(e.vakata.array_remove_item = (t, i) => {
										var r = e.inArray(i, t);
										return -1 !== r ? e.vakata.array_remove(t, r) : t;
									}),
									(e.vakata.array_filter = (e, t, i, r, s) => {
								...
								e.jstree.plugins.changed = function (_e, t) {
									var i = [];
								...
								(u.className = "jstree-icon jstree-checkbox"),
									...
									(e.jstree.plugins.checkbox = function (_i, r) {
										(this.bind = function () {
											r.bind.call(this),
											...
											(this.redraw_node = function (e, _t, i, _s) {
											...
											(this.delete_node = function (t) {
												...
												if (!(t = this.get_node(t)) || t.id === e.jstree.root)
													return !1;
												for (
													(i = t.children_d.concat([])).push(t.id),
														s = 0,
														a = i.length;
													s < a;
													s++
												...
												if (
													...
													if (o.children)
														for (i = 0, r = o.children.length; i < r; i++) {
															var l = o.children[i];
															(s = this._cascade_new_checked_state(l, t)),
																(d = d.concat(s)),
																s.indexOf(l) > -1 && c.push(l);
														}
													var h = this.get_node(o, !0),
											...
											(this.get_checked_descendants = function (t) {
												var r = this.settings.checkbox.tie_selection,
													s = this._model.data[t];
												return e.vakata.array_filter(
													s.children_d,
													(e) =>
														this._model.data[e].state[
															r ? "selected" : "checked"
														],
												);
											}),
									...
									(e.jstree.defaults.conditionalselect = () => !0),
									(e.jstree.plugins.conditionalselect = function (_e, t) {
											...
											ccp: {
												...
												submenu: {
													...
													paste: {
														...
														icon: !1,
														_disabled: (t) =>
															!e.jstree.reference(t.reference).can_paste(),
														separator_after: !1,
														label: "Paste",
														action: (t) => {
															var i = e.jstree.reference(t.reference),
									...
									(e.jstree.plugins.contextmenu = function (_i, r) {
										(this.bind = function () {
											r.bind.call(this);
											var t,
												i,
											...
											this.element
												...
												.on("touchstart.jstree", ".jstree-anchor", (r) => {
										...
										(e.vakata.context = {
											...
											_parse: (t, r) => {
												...
												return (
													...
													r && (a += "</ul>"),
													r ||
														((i.html = a), e.vakata.context._trigger("parse")),
													a.length > 10 && a
												);
											},
											_show_submenu: (i) => {
											...
											show: (r, s, a) => {
												var n,
													...
													g,
													f = !0;
												switch ((i.element?.length && i.element.width(""), f)) {
													case !s && !r:
														return !1;
													case !!s && !!r:
														(i.reference = r),
											...
											e(() => {
												...
												(i.element = e("<ul class='vakata-context'></ul>")),
															...
															e(this)
																...
																e.vakata.context.settings.hide_onmouseleave &&
																	(r = setTimeout(() => {
																		...
																		.vakata
																		.context.settings.hide_onmouseleave));
														})
													...
													e(d)
														.on("mousedown.vakata.jstree", (t) => {
															i.is_visible &&
																i.element[0] !== t.target &&
																!e.contains(i.element[0], t.target) &&
																e.vakata.context.hide();
														})
														.on("context_show.vakata.jstree", (_e, _r) => {
															i.element
																.find("li:has(ul)")
																.children("a")
									...
									(e.jstree.plugins.dnd = function (_t, i) {
										(this.init = function (e, t) {
															...
															if (
																...
																if (
																	((h = {
																		...
																		nodes:
																			r > 1 ? this.get_top_selected() : [i.id],
																	}),
																	(_ = t.currentTarget),
																	!this.settings.dnd.use_html5)
																)
											...
											(this.redraw_node = function (e, _t, _r, _s) {
												if (
									...
									e(() => {
										...
										e(d)
											...
											.on("dnd_start.vakata.jstree", (_e, t) => {
												(i = !1),
													(s = !1),
													t?.data?.jstree && n.appendTo(d.body);
											})
											.on("dnd_move.vakata.jstree", (_o, d) => {
											...
											.on("dnd_scroll.vakata.jstree", (_e, t) => {
												t?.data?.jstree &&
													(n.hide(),
													(i = !1),
													(s = !1),
											...
											.on("dnd_stop.vakata.jstree", function (_t, o) {
												if (
													(e(".jstree-dnd-parent").removeClass(
														"jstree-dnd-parent",
													),
											...
											.on("keyup.jstree keydown.jstree", (t, o) => {
												(o = e.vakata.dnd._get()) &&
													o.data &&
													o.data.jstree &&
									...
									((e) => {
										e.vakata.html = {
											div: e("<div></div>"),
											escape: (t) => e.vakata.html.div.text(t).html(),
											strip: (t) =>
												e.vakata.html.div.empty().append(e.parseHTML(t)).text(),
										};
										var i = {
											element: !1,
											target: !1,
											...
											start: (t, r, s) => {
												...
												try {
													(t.currentTarget.unselectable = "on"),
														(t.currentTarget.onselectstart = () => !1),
									...
									(e.jstree.plugins.massload = function (_t, i) {
										(this.init = function (e, t) {
									...
									(e.jstree.plugins.search = function (_i, r) {
										(this.bind = function () {
											r.bind.call(this),
																	...
																	if (
																		...
																		for (
																			...
																			o[o[i.res[r]].children_d[a]] &&
																				!o[o[i.res[r]].children_d[a]].state
																					.hidden &&
														...
														function (_e, t) {
															...
															r.text &&
																...
																(!l.search_leaves_only ||
																	(r.state.loaded &&
																		0 === r.children.length)) &&
																(l.search_callback?.call(this, i, r) ||
																	(!l.search_callback &&
																		u.search(r.text).isMatch)) &&
											...
											(this.redraw_node = function (t, _i, _s, _a) {
												if (
									...
									(e.jstree.plugins.sort = function (_e, t) {
										(this.bind = function () {
											t.bind.call(this),
												this.element
													.on(
								...
								(e.jstree.defaults.state = {
									...
									(e.jstree.plugins.state = function (_t, i) {
										(this.bind = function () {
											i.bind.call(this);
											var e = function () {
												this.element.on(
											...
											(this.restore_state = function () {
												...
												return (
													!(t?.ttl && t.sec && Date.now() - t.sec > t.ttl) &&
													(t?.state && (t = t.state),
													t &&
													...
													!!t &&
														(this.settings.state.preserve_loaded ||
															delete t.core.loaded,
														this.element.one("set_state.jstree", (_i, r) => {
									...
									((e) => {
										e.vakata.storage = {
											set: (e, t) => window.localStorage.setItem(e, t),
											get: (e) => window.localStorage.getItem(e),
											del: (e) => window.localStorage.removeItem(e),
										};
									})(e),
									(e.jstree.defaults.types = { default: {} }),
									(e.jstree.defaults.types[e.jstree.root] = {}),
									(e.jstree.plugins.types = function (_i, r) {
										(this.init = function (i, s) {
											...
											if (s?.types?.default)
												for (a in s.types)
													if (
														"default" !== a &&
														a !== e.jstree.root &&
														Object.hasOwn(s.types, a)
													)
														for (n in s.types.default)
															Object.hasOwn(s.types.default, n) &&
																s.types[a][n] === t &&
														...
														for (s = 0, a = d.length; s < a; s++) {
															if (
																...
																for (n in c[l].li_attr)
																	if (Object.hasOwn(c[l].li_attr, n)) {
																		if ("id" === n) continue;
																		o[d[s]].li_attr[n] === t
												...
												if (e.vakata.is_array(c))
													for (a = 0, n = c.length; a < n; a++)
														(c[a].type =
															...
															i?.no_id &&
																(delete c[a].id,
																c[a].li_attr?.id && delete c[a].li_attr.id,
																c[a].a_attr?.id && delete c[a].a_attr.id);
												else
													(c.type =
														(c.id || 0 === c.id) && o[c.id] && o[c.id].type
															? o[c.id].type
															: "default"),
														i?.no_id && (c = this._delete_ids(c));
												return c;
											}),
											(this._delete_ids = function (t) {
												...
												return (
													delete t.id,
													t.li_attr?.id && delete t.li_attr.id,
													t.a_attr?.id && delete t.a_attr.id,
													t.children &&
											...
											(this.check = function (i, s, a, n, o) {
												...
												(s = s && (s.id || 0 === s.id) ? s : this.get_node(s)),
													(a =
														a && (a.id || 0 === a.id) ? a : this.get_node(a));
												var d,
													c,
													l,
													h,
													_ =
														s && (s.id || 0 === s.id)
															...
															: null;
												switch (
													((_ = _?._model?.data ? _._model.data : null), i)
												) {
													case "create_node":
													case "move_node":
													case "copy_node":
											...
											(this.set_type = function (i, r) {
												...
												if (
													...
													for (c in s[o].li_attr)
														if (Object.hasOwn(s[o].li_attr, c)) {
															if ("id" === c) continue;
															"class" === c
																? ((_[i.id].li_attr.class = (
																		_[i.id].li_attr.class || ""
																	).replace(s[o].li_attr[c], "")),
																	l?.removeClass(s[o].li_attr[c]))
												...
												if (
													...
													for (c in s[o].a_attr)
														if (Object.hasOwn(s[o].a_attr, c)) {
															if ("id" === c) continue;
															"class" === c
																? ((_[i.id].a_attr.class = (
																		_[i.id].a_attr.class || ""
																	).replace(s[o].a_attr[c], "")),
																	h?.removeClass(s[o].a_attr[c]))
												...
												if (
													...
													for (c in s[r].li_attr)
														if (Object.hasOwn(s[r].li_attr, c)) {
															if ("id" === c) continue;
															_[i.id].li_attr[c] === t
												...
												if (
													s[r].a_attr !== t &&
													"object" === typeof s[r].a_attr
												)
													for (c in s[r].a_attr)
														if (Object.hasOwn(s[r].a_attr, c)) {
															if ("id" === c) continue;
															_[i.id].a_attr[c] === t
								...
								if (
									...
									(f.innerHTML = "&#160;"),
									(e.jstree.plugins.wholerow = function (_t, i) {
										(this.bind = function () {
											i.bind.call(this),
												this.element
													.on(
													...
													.on("click.jstree", ".jstree-wholerow", (t) => {
														t.stopImmediatePropagation();
														var i = e.Event("click", {
															metaKey: t.metaKey,
															ctrlKey: t.ctrlKey,
													...
													.on("dblclick.jstree", ".jstree-wholerow", (t) => {
														t.stopImmediatePropagation();
											...
											(this.redraw_node = function (t, _r, _s, _a) {
									...
									p.createdCallback = function () {
										...
										for (t in e.jstree.plugins)
											Object.hasOwn(e.jstree.plugins, t) &&
												this.attributes[t] &&
												(i.plugins.push(t),
												this.getAttribute(t) &&
										...
										for (t in e.jstree.defaults.core)
											Object.hasOwn(e.jstree.defaults.core, t) &&
												this.attributes[t] &&
												(i.core[t] =
													JSON.parse(this.getAttribute(t)) ||
													this.getAttribute(t));
							...
							void 0 === (a = "function" === typeof r ? r.apply(t, s) : r) ||
								(e.exports = a);
					})();
				},
				1145: (t) => {
