	...
	(() => {
		...
		function a(e) {
			...
			return {
				...
				items: [t],
				positions: [1 + n.findIndex((e) => e.objectID === t.objectID)],
		...
		function b(e) {
			for (var t = 1; t < arguments.length; t++) {
				...
				t % 2
					? d(Object(r), !0).forEach((t) => {
							g(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: d(Object(r)).forEach((t) => {
		...
		function h(e) {
			return e.map((e) => {
				...
				return b(
					...
					{
						objectIDs:
							(null == t ? void 0 : t.map((e) => e.objectID)) || r.objectIDs,
					},
				);
			});
		}
									...
									m(
										(function (e) {
											...
											b(
												...
												{
													objectIDs:
														(null == r ? void 0 : r.map((e) => e.objectID)) ||
														n.objectIDs,
												},
											),
										).map((e) => ({ items: r, payload: e })),
									),
								);
							}, [])
							.forEach((e) => {
		...
		var D = "2.15.0",
			...
			k = r((e) => {
				...
				t({
					insights: n,
					insightsEvents: _({ items: r }).map((e) =>
						E({ eventName: "Items Viewed" }, e),
					),
					state: o,
				});
			}, 400);
		function x(e) {
			...
			var v = O(m),
				...
				d = r((e) => {
					...
					if (t.isOpen) {
						var r = t.collections
							.reduce((e, t) => [].concat(P(e), P(t.items)), [])
							.filter(S);
						i(
							y.current.map((e) => e.objectID),
							r.map((e) => e.objectID),
						) ||
							((y.current = r),
							r.length > 0 &&
			...
			return {
				...
				subscribe: (e) => {
					...
					m("addAlgoliaAgent", "insights-plugin"),
						o(),
						m("onUserTokenChange", (e) => {
							o(e);
						}),
						m("getUserToken", null, (_e, t) => {
							o(t);
						}),
						r((e) => {
							var t = e.item,
		...
		function te(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? ee(Object(r), !0).forEach((t) => {
							re(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: ee(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
			...
			return te(
				...
				{},
				{
					...
					getSources: (r) =>
						Promise.all(
							[]
								.concat(Y(o.map((e) => e.getSources)), [e.getSources])
								.filter(Boolean)
								.map((e) =>
									((e, t) => {
										var r = [];
												...
												Promise.all(
													e
														...
														.map((e) => {
															...
															r.push(e.sourceId);
															var t = {
																getItemInputValue: (e) => e.state.query,
																getItemUrl: () => {},
																onSelect: (e) => {
																	(0, e.setIsOpen)(!1);
																},
		...
		function ue(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? ie(Object(r), !0).forEach((t) => {
							ae(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: ie(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function se(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? le(Object(r), !0).forEach((t) => {
							fe(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: le(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function de(e) {
			...
			return Promise.all(t).then((e) => F(e));
		}
		function be(e, t, r) {
			return t.map((t) => {
				var n,
					o = e.filter((e) => e.sourceId === t.sourceId),
					i = o.map((e) => e.items),
					u = o[0].transformResponse,
					a = u
						? u({
								results: (n = i),
								hits: n.map((e) => e.hits).filter(Boolean),
								facetHits: n
									.map((e) => {
										var t;
		...
		function ge(e, t) {
			var r = t;
			return {
				then: (t, n) => ge(e.then(_e(t, r, e), _e(n, r, e)), r),
				catch: (t) => ge(e.catch(_e(t, r, e)), r),
				finally: (t) => (
					t && r.onCancelList.push(t),
					ge(e.finally(_e(t && (() => ((r.onCancelList = []), t())), r, e)), r)
				),
				cancel: () => {
					r.isCanceled = !0;
				...
				isCanceled: () => !0 === r.isCanceled,
			};
		}
		function he(e) {
			return ge(new Promise((t, r) => e(t, r)), {
				isCanceled: !1,
				onCancelList: [],
			});
		}
		...
		function _e(e, t, r) {
			return e ? (r) => (t.isCanceled ? r : e(r)) : r;
		}
		function Se(e) {
			var t = ((e) => {
				var t = e.collections
		...
		(he.resolve = (e) => Oe(Promise.resolve(e))),
			(he.reject = (e) => Oe(Promise.reject(e)));
		...
		function Te(e) {
			...
			if ((f(i), p(o.defaultActiveItemId), !i && !1 === o.openOnFocus)) {
				var y,
					d = a
						.getState()
						.collections.map((e) => Ie(Ie({}, e), {}, { items: [] }));
				m("idle"),
					l(d),
					s(
				...
				var b = Oe(Ne(d).then(() => Promise.resolve()));
				return a.pendingRequests.add(b);
			}
			m("loading"),
				(xe = o.environment.setTimeout(() => {
					m("stalled");
				}, o.stallThreshold));
			var g = Oe(
				Ne(
						...
						.then((e) =>
							Promise.all(
								e.map((e) =>
									...
									).then((t) => ye(t, e.sourceId, a.getState())),
								),
							)
								.then(de)
								.then((t) => {
								...
								.then((e) =>
									((e) => {
										...
										return F(
											...
											.filter(Boolean)
											.map((e) => ({ source: e, items: e.getItems() }));
		...
		function Ye(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? Xe(Object(r), !0).forEach((t) => {
							Ze(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: Xe(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function tt(e) {
			...
			return {
				getEnvironmentProps: (e) => {
					...
					function u(e) {
						(!n.getState().isOpen && n.pendingRequests.isEmpty()) ||
							...
							(!1 ===
								[o, i].some(
									(t) => ((r = t), (n = e.target), r === n || r.contains(n)),
								) &&
				...
				getLabelProps: (e) =>
					Ye({ htmlFor: Be(t.id, "input"), id: Be(t.id, "label") }, e),
				getInputProps: (e) => {
					var i;
					function a(e) {
					...
					var c = e || {},
						...
						f = et(c, ze),
						p = Se(n.getState()),
						m = ((e) => Boolean(e?.match(He)))(
							(null === (i = t.environment.navigator) || void 0 === i
								? void 0
								: i.userAgent) || "",
						),
						v = t.enterKeyHint || (p?.itemUrl && !m ? "go" : "search");
					return Ye(
						{
		...
		function ut(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? it(Object(r), !0).forEach((t) => {
							at(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: it(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function mt(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? pt(Object(r), !0).forEach((t) => {
							vt(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: pt(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
			...
			switch (t.type) {
				...
				case "ArrowDown": {
					var r = mt(
						...
						{},
						{
							activeItemId: Object.hasOwn(t.payload, "nextActiveItemId")
		...
		function gt(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? bt(Object(r), !0).forEach((t) => {
							ht(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: bt(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function Ot(e) {
			...
			function c() {
				return r.plugins.some((e) => "aa.algoliaInsightsPlugin" === e.name);
			}
			if (r.insights && !c()) {
		...
		function zt(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? Kt(Object(r), !0).forEach((t) => {
							Gt(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: Kt(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
			...
			e: if ("function" === typeof I)
				try {
					if (
						...
						f.componentWillUpdate?.(b, f.__s, O),
							g &&
		...
		function Nr(e, t, r) {
			var n, o, i, u;
			Xt.__?.(e, t),
				(o = (n = "function" === typeof r) ? null : r?.__k || t.__k),
				(i = []),
				(u = []),
				Er(
					t,
		...
		function Mr(e) {
			...
			function n(e) {
				...
				return t(
					r,
					{},
					Ur({ hit: n, attribute: o }).map((e, r) =>
						e.isHighlighted ? t(u, { key: r }, e.value) : e.value,
					),
				);
			}
			...
			var r,
				...
				a =
					(null === (n = e[t - 1]) || void 0 === n
						...
						: n.isHighlighted) || !0;
			return Vr.test(
				(o = i.value) && Qr.test(o) ? o.replace(Wr, (e) => Hr[e]) : o,
			) || a !== u
				? i.isHighlighted
				: a;
		}
		...
		function Gr(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? zr(Object(r), !0).forEach((t) => {
							Jr(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: zr(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function Xr(e) {
			return e.some((e) => e.isHighlighted)
				? e.map((t, r) => Gr(Gr({}, t), {}, { isHighlighted: !$r(e, r) }))
				: e.map((e) => Gr(Gr({}, e), {}, { isHighlighted: !1 }));
		}
		function Yr(e) {
			var t = e.createElement,
				r = e.Fragment;
			function n(e) {
				...
				return t(
					r,
					{},
					((n = { hit: o, attribute: i }), Xr(Ur(n))).map((e, r) =>
		...
		function rn(e) {
			...
			function n(e) {
				...
				return t(
					r,
					{},
					((n = { hit: o, attribute: i }), Xr(tn(n))).map((e, r) =>
						e.isHighlighted ? t(a, { key: r }, e.value) : e.value,
					),
				);
			}
		...
		function sn(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? ln(Object(r), !0).forEach((t) => {
							fn(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: ln(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function On(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? hn(Object(r), !0).forEach((t) => {
							_n(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: hn(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function Cn(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? Dn(Object(r), !0).forEach((t) => {
							kn(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: Dn(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function Ln(e) {
			for (var t = 1; t < arguments.length; t++) {
				var r = null != arguments[t] ? arguments[t] : {};
				t % 2
					? Rn(Object(r), !0).forEach((t) => {
							Fn(e, t, r[t]);
						})
					: Object.getOwnPropertyDescriptors
						? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r))
						: Rn(Object(r)).forEach((t) => {
								Object.defineProperty(
									e,
									t,
									Object.getOwnPropertyDescriptor(r, t),
		...
		function Un(e) {
			var t,
					...
					((e) => {
						...
						return {
							renderer: {
								...
								getInputProps: null != u ? u : (e) => e.props,
					...
					Ot(
						Ln(
							...
							{},
							{
								onStateChange: (e) => {
									var t, r, n;
									(f.current = e.state.collections.some(
				...
				O = l(() => jt.bind(v.value.renderer.renderer.createElement)),
				_ = l(() =>
					((e) => {
				...
				(p.current = En(
					...
					v.value.core,
					{
						components:
							((t = o),
							(r = (e) =>
								!Object.hasOwn(e.value, "__autocomplete_componentName")),
