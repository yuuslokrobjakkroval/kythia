				...
				2624: (_e, t) => {
					!((e) => {
						...
						var D = "top",
							...
							B = "viewport",
							H = "popper",
							T = k.reduce((e, t) => e.concat([`${t}-${W}`, `${t}-${S}`]), []),
							R = []
								.concat(k, [L])
								.reduce((e, t) => e.concat([t, `${t}-${W}`, `${t}-${S}`]), []),
							V = [
								"beforeRead",
								"read",
								"afterRead",
												...
												if (Q(t, n)) {
													(f.rects = {
														...
														f.orderedModifiers.forEach(
															(e) =>
																(f.modifiersData[e.name] = Object.assign(
																	{},
																	e.data,
																)),
														);
						...
						function re(e) {
							var n,
								...
								b = void 0 === g ? 0 : g,
								x =
									"function" === typeof l ? l({ x: y, y: b }) : { x: y, y: b };
							(y = x.x), (b = x.y);
