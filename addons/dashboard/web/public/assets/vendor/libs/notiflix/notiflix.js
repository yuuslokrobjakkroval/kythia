							...
							((e) => {
								...
								var t,
									...
									m = (t) => {
										...
										return (
											(i.innerHTML = t), i.textContent || i.innerText || ""
										);
									},
									f = (e, t) => (
										e || (e = "60px"),
									...
									h = () =>
										'[id^=NotiflixBlockWrap]{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-box-sizing:border-box;box-sizing:border-box;position:absolute;z-index:1000;font-family:"Quicksand",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;background:rgba(255,255,255,.9);text-align:center;animation-duration:.4s;width:100%;height:100%;left:0;top:0;border-radius:inherit;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center}[id^=NotiflixBlockWrap] *{-webkit-box-sizing:border-box;box-sizing:border-box}[id^=NotiflixBlockWrap]>span[class*="-icon"]{display:block;width:45px;height:45px;position:relative;margin:0 auto}[id^=NotiflixBlockWrap]>span[class*="-icon"] svg{width:inherit;height:inherit}[id^=NotiflixBlockWrap]>span[class*="-message"]{position:relative;display:block;width:100%;margin:10px auto 0;padding:0 10px;font-family:inherit!important;font-weight:normal;font-size:14px;line-height:1.4}[id^=NotiflixBlockWrap].nx-with-animation{-webkit-animation:block-animation-fade .3s ease-in-out 0s normal;animation:block-animation-fade .3s ease-in-out 0s normal}@-webkit-keyframes block-animation-fade{0%{opacity:0}100%{opacity:1}}@keyframes block-animation-fade{0%{opacity:0}100%{opacity:1}}[id^=NotiflixBlockWrap].nx-with-animation.nx-remove{opacity:0;-webkit-animation:block-animation-fade-remove .3s ease-in-out 0s normal;animation:block-animation-fade-remove .3s ease-in-out 0s normal}@-webkit-keyframes block-animation-fade-remove{0%{opacity:1}100%{opacity:0}}@keyframes block-animation-fade-remove{0%{opacity:1}100%{opacity:0}}',
									k = 0,
									y = (l, h, y, v, x, N) => {
										var S;
										if (Array.isArray(y)) {
											...
											Object.prototype.isPrototypeOf.call(NodeList.prototype, y)
										) {
											if (y.length < 1)
												return (
													o(
										...
										var M = "";
										"string" === typeof v && v.length > 0 && (M = v),
											t.cssAnimation || (t.cssAnimationDuration = 0);
										var T = a.className;
										"string" === typeof t.className && (T = t.className.trim());
										var A =
												"number" === typeof t.querySelectorLimit
													? t.querySelectorLimit
													: 200,
										...
										if (l)
											for (
												...
												var X = S[D];
												if (X) {
													if (H.indexOf(X.tagName.toLocaleLowerCase("en")) > -1)
														break;
														...
														var P = e
															...
															U =
																"string" === typeof P
																	...
																	: "relative",
															V =
																Math.round(1.25 * parseInt(t.svgSize, 10)) + 40,
															q = "";
														V > (X.offsetHeight || 0) &&
															(q = `min-height:${V}px;`);
														var R = "";
											...
											var K = (i) => {
													var n = setTimeout(() => {
														...
														a?.parentNode?.removeChild(a), clearTimeout(n);
									...
									w = {
										Block: {
											...
											remove: (e, t) => {
												"number" !== typeof t && (t = 0),
													y(!1, null, e, null, null, t);
											},
										},
									};
								return "object" === typeof e.Notiflix
									? c(!0, e.Notiflix, { Block: w.Block })
									: { Block: w.Block };
							})(a)).apply(t, [])),
					...
					(a =
						...
						(n = (() =>
							((e) => {
								...
								var t,
										...
										if (("string" === typeof h && h.length > 0 && (S = h), y)) {
											...
											var j = e.document.getElementById(a.ID),
												H = setTimeout(() => {
													...
													var e = setTimeout(() => {
														null !== j.parentNode &&
															(j.parentNode.removeChild(j), clearTimeout(e));
													}, t.cssAnimationDuration);
													clearTimeout(H);
												}, v);
										t = l(!0, t, x);
									...
									y = (i) => {
										...
										if (n)
											if (i.length > 0) {
												i =
													i.length > t.messageMaxLength
														? `${c(i).substring(0, t.messageMaxLength)}...`
														: c(i);
								...
								return "object" === typeof e.Notiflix
									? l(!0, e.Notiflix, { Loading: w.Loading })
									: { Loading: w.Loading };
							})(a)).apply(t, [])),
						void 0 === n || (e.exports = n);
				},
