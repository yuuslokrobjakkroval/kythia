...
!((e, t) => {
	...
	(() => {
		...
		class r {
			...
			static range(e, t) {
				return t
					? e?.loc && t.loc && e.loc.lexer === t.loc.lexer
		...
		var l = function e(t) {
			...
			h = {
				...
				escape: (e) => String(e).replace(s, (e) => o[e]),
				hyphenate: (e) => e.replace(i, "-$1").toLowerCase(),
				getBaseElem: l,
				isCharacterBox: (e) => {
					var t = l(e);
					return (
			...
			m = {
				...
				maxExpand: {
					...
					processor: (e) => Math.max(0, e),
					cli: "-e, --max-expand <n>",
					cliProcessor: (e) => ("Infinity" === e ? 1 / 0 : parseInt(e, 10)),
				},
		...
		var R = [
			...
			O = (e, t) => (t.size < 2 ? e : R[e - 1][t.size - 1]);
		class E {
			constructor(e) {
				(this.style = void 0),
					(this.color = void 0),
					...
					this._fontMetrics ||
						(this._fontMetrics = ((e) => {
							...
							if (!I[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
								...
								for (var a in C) Object.hasOwn(C, a) && (r[a] = C[a][t]);
							}
							return I[t];
						})(this.size)),
					this._fontMetrics
		...
		var L = {
			...
			Y = function (e) {
				...
				for (var r in ((t.className = G(this.classes)), this.style))
					Object.hasOwn(this.style, r) && (t.style[r] = this.style[r]);
				for (var a in this.attributes)
					Object.hasOwn(this.attributes, a) &&
		...
		class j {
			...
			toNode() {
				...
				(e.className = "mord"),
				this.style))
					Object.hasOwn(this.style, t) && (e.style[t] = this.style[t]);
				return e;
			}
			toMarkup() {
				var e =
		...
		var De = [
			...
			Ge = (e, t) => {
				...
				for (var a in e.style)
					if (Object.hasOwn(e.style, a) && e.style[a] !== t.style[a]) return !1;
				for (var n in t.style)
					if (Object.hasOwn(t.style, n) && e.style[n] !== t.style[n]) return !1;
				return !0;
			},
			Ue = (e) => {
			...
			Ze = {
				...
				makeFragment: Xe,
				wrapFragment: (e, t) => (e instanceof T ? Ye([], [e], t) : e),
				makeVList: (e, _t) => {
					for (
						var { children: r, depth: a } = ((e) => {
				...
				makeOrd: (e, t, r) => {
					...
					if (l) {
						...
						if ("boldsymbol" === l) {
							var u = ((e, t, _r, _a, n) =>
								"textord" !== n && Ve(e, "Math-BoldItalic", t).metrics
						...
						if (Object.hasOwn(xe, i) && "Typewriter" === c.slice(0, 10)) {
		...
		var st = (e) =>
			...
			bt = (e, t) =>
				e ? (t && (e = vt(e, t)), ut[e.classes[0]] || null) : null,
			yt = (e, t) => {
		...
		var At = {
			...
			Bt = (e) => (1 === e.length ? e[0] : new At.MathNode("mrow", e)),
			Ct = (e, t) => {
				...
				return h.contains(["\\imath", "\\jmath"], n)
					? null
					: (ae[a][n]?.replace && (n = ae[a][n].replace),
		...
		function Ut(e) {
			return e && ("atom" === e.type || Object.hasOwn(re, e.type)) ? e : null;
		}
		var Yt = (e, t) => {
				var r, a, n;
				e && "supsub" === e.type
		...
		var or = (e, t, r) => {
				var a = q(ae.math[e]?.replace || e, t, r);
			...
			hr = (e, t, r, a, n, i) => {
				var o = ((e, t, r, a) => Ze.makeSymbol(e, `Size${t}-Regular`, r, a))(
						e,
						t,
						n,
						a,
		...
		Er({
			...
			props: { numArgs: 1 },
			handler(e, t) {
				var r = (Ut(t[0]) ? [t[0]] : Ft(t[0], "ordgroup").body).map((e) => {
						var t = Gt(e).text;
		...
		ot({
			...
			htmlBuilder(e, t) {
				...
				if (Object.hasOwn(va, e.text))
					return Ze.makeSpan(["mspace", va[e.text]], [], t);
				throw new n(`Unknown type of space "${e.text}"`);
			},
			mathmlBuilder(e, _t) {
				if (!Object.hasOwn(ba, e.text)) {
					if (Object.hasOwn(va, e.text)) return new At.MathNode("mspace");
					throw new n(`Unknown type of space "${e.text}"`);
				}
		...
		class Ia {
			...
			has(e) {
				return (
					Object.hasOwn(this.current, e) || Object.hasOwn(this.builtins, e)
				);
			}
			get(e) {
				return Object.hasOwn(this.current, e)
					? this.current[e]
					: this.builtins[e];
			}
			set(e, t, r) {
				if ((void 0 === r && (r = !1), r)) {
					...
					n && !Object.hasOwn(n, e) && (n[e] = this.current[e]);
				}
		...
		Dr("\\noexpand", (e) => {
			...
			Dr("\\@firstoftwo", (e) => ({ tokens: e.consumeArgs(2)[0], numArgs: 0 })),
			Dr("\\@secondoftwo", (e) => ({
		...
		var Oa = (e, t, r) => {
			...
			if (1 === (a = e.consumeArg().tokens).length && "[" === a[0].text) {
				...
				(s = parseInt(l, 10)), (a = e.consumeArg().tokens);
			}
		...
		Dr("\\dotso", (e) => (e.future().text in La ? "\\ldots\\," : "\\ldots")),
			Dr("\\dotsc", (e) => {
				var t = e.future().text;
				return t in La && "," !== t ? "\\ldots\\," : "\\ldots";
			}),
			Dr("\\cdots", (e) =>
				e.future().text in La ? "\\@cdots\\," : "\\@cdots",
			),
			Dr("\\dotsb", "\\cdots"),
			Dr("\\dotsm", "\\cdots"),
			Dr("\\dotsi", "\\!\\cdots"),
		...
		class Fa {
			...
			isDefined(e) {
				return (
					this.macros.has(e) ||
					Object.hasOwn(za, e) ||
					Object.hasOwn(ae.math, e) ||
					Object.hasOwn(ae.text, e) ||
					Object.hasOwn(Va, e)
				);
			}
			isExpandable(e) {
				...
				return null != t
					...
					: Object.hasOwn(za, e) && !za[e].primitive;
			}
		}
		...
		var $a = (e, t, r) => {
			...
			Ka = {
				version: "0.16.15",
				render: ja,
				renderToString: (e, t) => Za(e, t).toMarkup(),
				ParseError: n,
				SETTINGS_SCHEMA: m,
				__parse: (e, t) => {
					var r = new p(t);
