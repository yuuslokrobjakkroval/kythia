	...
	(() => {
		var t = {
				...
				3465: (t, e, n) => {
					...
					function St(t, e) {
						var n =
								Vt(t) ||
								((t) =>
									((t) => ((t) => !!t && "object" === typeof t)(t) && Kt(t))(
										t,
									) &&
									tt.call(t, "callee") &&
									(!at.call(t, "callee") || et.call(t) === i))(t)
									? ((t, e) => {
					...
					function Ct(t, e, n, r, s, f, v) {
						...
						if (j) {
							...
							if (R === d || R === i || (I && !f)) {
								...
								if (
									((T = ((t) =>
										"function" !== typeof t.constructor || Ft(t)
											? {}
											: ((e = ot(t)), Gt(e) ? lt(e) : {}))(I ? {} : t)),
									!e)
								)
									return ((t, e) => Mt(t, Ut(t), e))(
										t,
										((t, e) => t && Mt(e, Xt(e), t))(T, t),
									);
							} else {
								if (!C[R]) return f ? t : {};
								T = ((t, e, n, r) => {
					...
					function Dt(t, e) {
						var n = ((t, e) => (null == t ? void 0 : t[e]))(t, e);
					...
					(kt.prototype.clear = function () {
						...
						(_t.prototype.delete = function (t) {
							...
							return (
								!(n < 0) &&
								(n === e.length - 1 ? e.pop() : ct.call(e, n, 1), !0)
							);
						}),
					...
					function Kt(t) {
						return (
							null != t &&
							((t) => "number" === typeof t && t > -1 && t % 1 === 0 && t <= s)(
								t.length,
							) &&
							!Zt(t)
						);
				...
				2307: (t, e, n) => {
					...
					var B,
						...
						rt = ((D = Object.keys), (U = Object), (t) => D(U(t))),
						st = jt(_, "DataView"),
						it = jt(_, "Map"),
						ot = jt(_, "Promise"),
						lt = jt(_, "Set"),
					...
					(bt.prototype.clear = function () {
						...
						(vt.prototype.delete = function (t) {
							...
							return (
								!(n < 0) &&
								(n === e.length - 1 ? e.pop() : J.call(e, n, 1),
								--this.size,
								!0)
							);
						}),
					...
					var Dt = qt(
							...
							? qt
							: (t) => $t(t) && V.call(t, "callee") && !Q.call(t, "callee"),
						Ut = Array.isArray;
					var Pt = nt || (() => !1);
					function zt(t) {
						if (!Ht(t)) return !1;
					...
					var Vt = C
						...
						: (t) => $t(t) && Ft(t.length) && !!A[At(t)];
					function Kt(t) {
						return null != (e = t) && Ft(e.length) && !zt(e) ? Et(t) : Lt(t);
						var e;
					}
					t.exports = (t, e) => kt(t, e);
				},
				1210: (_t, e, n) => {
		...
		return (
			(function () {
				...
				var $ = (t) => !(!S(t) || I(t)) && (j(t) ? H : D).test(B(t));
				var V = (t, e) => (null == t ? void 0 : t[e]);
				var K = (t, e) => {
						var n = V(t, e);
						return $(n) ? n : void 0;
					},
				...
				var It = (t) =>
					"function" !== typeof t.constructor || Rt(t) ? {} : St(jt(t));
				var Mt = (t) => null != t && "object" === typeof t;
				var Bt = (t) => Mt(t) && "[object Arguments]" === O(t),
					Dt = Object.prototype,
					...
					zt = Bt(
						...
						? Bt
						: (t) => Mt(t) && Ut.call(t, "callee") && !Pt.call(t, "callee"),
					Ft = zt,
					Ht = Array.isArray;
				var $t = (t) =>
					"number" === typeof t &&
					...
					t % 1 === 0 &&
					t <= 9007199254740991;
				var Vt = (t) => null != t && $t(t.length) && !j(t);
				var Kt = (t) => Mt(t) && Vt(t);
				var Wt = () => !1,
					Zt =
						"object" === typeof exports &&
				...
				var re = (t) => {
						...
						return (
							"function" === typeof n && n instanceof n && te.call(n) === ne
						);
					},
					se = {};
				(se["[object Float32Array]"] =
					...
					(se["[object Arguments]"] =
						...
						se["[object WeakMap]"] =
							!1);
				var ie = (t) => Mt(t) && $t(t.length) && !!se[O(t)];
				var oe = (t) => (e) => t(e),
					le =
						"object" === typeof exports &&
						exports &&
					...
					ue = (() => {
						try {
							var t = ae?.require?.("util").types;
							return t || ce?.binding?.("util");
						} catch (_t) {}
					})(),
					he = ue?.isTypedArray,
					de = he ? oe(he) : ie;
				...
				var qe = (t) => (Vt(t) ? Ne(t, !0) : Ae(t));
				var ke = (t) => me(t, qe(t));
				var _e = (t, e, n, r, s, i, o) => {
					var l = fe(t, n),
						a = fe(e, n),
						c = o.get(a);
					if (c) vt(t, n, c);
				...
				var je = (t, e, n) => (
					...
					function () {
						for (
							var r = arguments, s = -1, i = Te(r.length - e, 0), o = Array(i);
							++s < i;
						)
							o[s] = r[e + s];
						s = -1;
				...
				const $e = class t {
					...
					static find(t, e = !1) {
						...
						if (t.blots.has(t)) return t.blots.get(t) || null;
						if (e) {
							let n = null;
							try {
								n = t.parentNode;
				...
				const Xe = class {
					...
					Ye = class {
						...
						detach() {
							this.parent?.removeChild(this), Ve.blots.delete(this.domNode);
						}
						deleteAt(t, e) {
				...
				const rn = class t extends Qe {
					...
					split(t, e = !1) {
						...
						return (
							this.parent?.insertBefore(n, this.next || void 0),
							this.children.forEachAt(t, this.length(), (t, r, _s) => {
								const i = t.split(r, e);
					...
					splitAfter(t) {
						...
						return this.parent?.insertBefore(e, this.next || void 0), e;
					}
					unwrap() {
				...
				const on = class t extends sn {
					...
					static formats(e, n) {
						...
						if (null == r || e.tagName !== r.tagName) {
							if ("string" === typeof t.tagName) return !0;
							if (Array.isArray(t.tagName)) return e.tagName.toLowerCase();
						}
					}
					constructor(t, e) {
				...
				var wn = (t) => (Vt(t) ? Ne(t) : En(t));
				var An = (t, e) => t && me(e, wn(e), t);
				var qn = (t, e) => t && me(e, qe(e), t);
				var kn = (t, e) => {
					for (
				...
				var _n = () => [],
					...
					Sn = On
						? (t) =>
								null == t
									? []
									: ((t = Object(t)), kn(On(t), (e) => Ln.call(t, e)))
						: _n;
				var Tn = (t, e) => me(t, Sn(t), e);
				var jn = (t, e) => {
						for (var n = -1, r = e.length, s = t.length; ++n < r; )
							t[s + n] = e[n];
						return t;
				...
				var cr = (t) => Mt(t) && "[object Map]" === Jn(t),
					ur = ue?.isMap,
					hr = ur ? oe(ur) : cr;
				var dr = (t) => Mt(t) && "[object Set]" === Jn(t),
					fr = ue?.isSet,
					pr = fr ? oe(fr) : dr,
					gr = "[object Arguments]",
					mr = "[object Function]",
				...
				class Jr extends dn {
					...
					restore() {
						...
						if (((i.data = Jr.CONTENTS), e))
							(l = e), (o || r) && (e.insertAt(e.length(), o + s), r?.remove());
				...
				var fs = class {
					constructor(t, e) {
						(this.emitter = e),
							...
							this.emitter.on(cs.events.SCROLL_OPTIMIZE, (_t, e) => {
								if (e.range) {
									const {
										startNode: t,
										startOffset: n,
					...
					format(t, e) {
						...
						if (n?.native.collapsed && !this.scroll.query(t, ze.BLOCK)) {
				...
				class Ms {
					...
					static register() {
						if (
							...
							null == Ms.imports[t] || n || Rs.warn(`Overwriting ${t} with`, e),
								(Ms.imports[t] = e),
				...
				function Bi(t, e, n, r) {
					return r.query(e)
						? t.reduce((t, r) => {
								...
								if (r.attributes?.[e]) return t.push(r);
								const s = n ? { [e]: n } : {};
				...
				class ao extends Zr {
					...
					static create(t) {
						const e = Zr.create(t);
						return (
							e.setAttribute("href", ao.sanitize(t)),
					...
					static sanitize(t) {
						return co(t, ao.PROTOCOL_WHITELIST) ? t : ao.SANITIZED_URL;
					}
					format(t, e) {
						t === this.statics.blotName && e
				...
				var mo = class extends dn {
					...
					static create(t) {
						const e = dn.create(t);
						return (
							"string" === typeof t && e.setAttribute("src", this.sanitize(t)),
							e
						);
					}
					static formats(t) {
				...
				class xo extends Zr {
					static formats(t, e) {
						for (; null != t && t !== e.domNode; ) {
							if (t.classList?.contains(si.className)) return Zr.formats(t, e);
							t = t.parentNode;
						}
					}
					constructor(t, e, n) {
						...
						this.quill.on(Ms.events.SCROLL_OPTIMIZE, (t) => {
							t.some(
								(t) =>
									...
									(this.quill.once(Ms.events.TEXT_CHANGE, (_t, _e, n) => {
				...
				class Xo extends Wo {
					...
					constructor(t, e) {
						super(t, e),
							this.quill.on(cs.events.EDITOR_CHANGE, (t, e, _n, r) => {
				...
				class Jo extends Wo {
					...
					listen() {
						super.listen(),
							...
							this.quill.on(cs.events.SELECTION_CHANGE, (t, _e, n) => {
								if (null != t) {
