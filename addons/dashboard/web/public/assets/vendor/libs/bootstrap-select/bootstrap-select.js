				...
				1936: () => {
					!((e) => {
						...
						function r(t, s) {
							...
							for (
								var r = e(s).filter((_e, t) => t instanceof RegExp),
									a = 0,
									c = r.length;
								a < c;
								a++
							...
							var a = this.each(function () {
								...
								if (i.is("select")) {
									...
									if ((r.title && (r.placeholder = r.title), l)) {
										if (r)
											for (var a in r)
												Object.hasOwn(r, a) && (l.options[a] = r[a]);
									} else {
										var d = i.data();
										for (var h in d)
											Object.hasOwn(d, h) &&
							...
							(te.prototype = {
								...
								createView: function (t, i, s) {
										...
										if (
											...
											if (t && i) {
												...
												n.selectpicker.view.canHighlight[P] ||
													...
													(n.activeElement =
														n.selectpicker.current.data[P]?.element),
													n.focusItem(M);
											}
									...
									h(o, !0),
										this.$menuInner
											...
											.on("scroll.createView", function (_e, t) {
								...
								setPlaceholder: function () {
									...
									if (
										...
										var i = this.$element[0],
											...
											a = r ? r.index : 0,
											c = window.performance?.getEntriesByType("navigation"),
											d = c?.length
											...
											"function" === typeof l
												? l.call(
														...
														(i, s, l) => {
															...
															(r.hasMore = s),
																(r.totalItems = l),
																(n = this.buildData(i, t)),
																e.call(this, n),
																this.$element.trigger(`fetched${F}`);
														},
														i,
														s,
													)
								...
								buildData: function (t, i) {
									...
									for (var f = d.length, m = c; m < f; m++) {
										var v = d[m],
											g = v.children;
										g?.length ? u.call(this, m, d) : p.call(this, v, {});
									}
									switch (i) {
										case "data":
									...
									if (
										(this.options.source.data &&
											...
											(l.map(function e(t) {
												t.selected
													? s.createOption(t, !0)
													: t.children?.length && t.children.map(e);
											}),
								...
								getSelectPosition: function () {
									...
									this.options.container && o.length && !o.is("body")
										? (((t = o.offset()).top += parseInt(
											...
											(t.left += parseInt(o.css("borderLeftWidth"), 10)))
										: (t = { top: 0, left: 0 });
									var l = this.options.windowPadding;
											...
											this.$bsContainer
												...
												o.is("body")
													...
													: (((i = o.offset()).top +=
															...
															o.scrollTop()),
														(i.left +=
															parseInt(o.css("borderLeftWidth"), 10) -
															o.scrollLeft())),
								...
								clickListener: function () {
									...
									function n() {
										t.dropdown?._popper?.state ? s() : requestAnimationFrame(n);
									}
									i.data("spaceSelect", !1),
										...
										this.$menuInner.on("mouseenter", "li a", function (_e) {
										...
										this.$menuInner.on("click", "li a", function (i, s) {
											...
											if (
												...
												var f = r.option,
													m = e(f),
													b = f.selected,
													k = t.selectpicker.current.data.find(
														(e) =>
															e.optID === r.optID &&
													...
													y =
														I instanceof Element
															...
															: J.fromDataSource,
													x = I?.children,
													E = parseInt(t.options.maxOptions, 10),
													$ = (I && parseInt(y(I, "maxOptions"), 10)) || !1;
												if (
										...
										this.$searchbox.on("input propertychange", () => {
											...
											if (
												...
												if (
													...
													for (
														var a = 0;
														a < this.selectpicker.main.data.length;
														a++
													) {
										...
										if (
											...
											if (
												...
												t.which === B
													...
													(c.activeElement =
														c.selectpicker.current.data[v]?.element),
													c.focusItem(n),
