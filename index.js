...
const { isTeam, isOwner, embedFooter, isPremium, isVoterActive } = require('@coreHelpers/discord'); // Discord helper funcs for permissions/identity
...
const dependencies = {
    ...
    models: {},
    helpers: {
        discord: { isTeam, isOwner, embedFooter, isPremium, isVoterActive },
        color: { convertColor },
